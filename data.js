...
const concepts = [ // Ensure commas after lore arrays and inside lore arrays where needed
    // --- Common Concepts ---

{
    id: 1, name: "Vanilla Sex", cardType: "Practice/Kink", visualHandle: "common_vanilla.jpg", primaryElement: "S", elementScores: { A: 5, I: 5, S: 3, P: 4, C: 3, R: 4 }, briefDescription: "The 'classic hits' repertoire of intimacy.", detailedDescription: "Often referring to widely accepted forms of sexual expression, commonly centered around penetrative intercourse (vaginal or anal), kissing, mutual masturbation, and oral sex, typically within a familiar emotional context like romance or affection. It's the comfortable baseline for many, the 'common tongue' of intimacy. However, 'vanilla' doesn't inherently mean boring or lacking depth; passionate, connected vanilla sex can be incredibly fulfilling if it genuinely resonates!", relatedIds: [2, 3, 33, 67, 71], rarity: 'common', keywords: ['Conventional', 'Physical', 'Simple', 'Mainstream', 'Comfortable', 'Familiar', 'Baseline'],
    lore: [
...
{
    id: 2, name: "Sensual Touch", cardType: "Practice/Kink", visualHandle: "common_sensual_touch.jpg", primaryElement: "S", elementScores: { A: 4, I: 4, S: 4, P: 5, C: 2, R: 4 }, briefDescription: "Gentle, connected, mindful exploration through touch.", detailedDescription: "Slowing *way* down to truly *feel* and connect through the skin. This isn't about rushing towards a specific goal, but about savoring the journey of sensation itself. Think soft, loving caresses exploring the landscape of the body, sharing warmth like a gentle current, communicating profound care and attention without needing words. It's presence embodied in the fingertips, a meditation shared between partners.", relatedIds: [1, 15, 31, 3, 80, 102, 48], rarity: 'common', keywords: ['Gentle', 'Affection', 'Connection', 'Sensation', 'Comfort', 'Slow', 'Mindful', 'Presence', 'Caress'],
    lore: [
...
{
    id: 3, name: "Passionate Kissing", cardType: "Practice/Kink", visualHandle: "common_kissing.jpg", primaryElement: "S", elementScores: { A: 6, I: 5, S: 5, P: 6, C: 3, R: 5 }, briefDescription: "Kissing like the world melts away.", detailedDescription: "Far more than just a polite peck or a prelude! This is when kissing becomes an entire conversation, a dynamic dance of lips and tongues conveying urgency, deep tenderness, simmering hunger, playful teasing, or profound devotion. It can be an intimate exploration, a bold declaration, a merging, a world unto itself built in the space between breaths.", relatedIds: [1, 2, 15, 47, 66, 85, 77], rarity: 'common', keywords: ['Intensity', 'Emotion', 'Connection', 'Sensation', 'Intimacy', 'Kissing', 'Mouth', 'Expression', 'Desire'],
    lore: [
...
{
    id: 15, name: "Deep Emotional Intimacy", cardType: "Psychological/Goal", visualHandle: "uncommon_intimacy_art.jpg", primaryElement: "P", elementScores: { A: 7, I: 5, S: 4, P: 9, C: 5, R: 7 }, briefDescription: "Seeking that profound 'soul-to-soul' connection.", detailedDescription: "For those who pursue this, sex can be a powerful, sacred conduit to achieving profound emotional closeness. It's about courageously sharing vulnerabilities, building unshakeable trust, and experiencing the profound relief and joy of feeling truly seen, understood, and accepted, flaws and all. It's weaving souls together, not just mingling bodies; the physical becomes a language for the heart.", relatedIds: [2, 3, 22, 29, 47, 58, 68, 70, 75, 76, 82, 83, 123, 59, 69], rarity: 'uncommon', keywords: ['Connection', 'Vulnerability', 'Trust', 'Psychological', 'Emotion', 'Soul', 'Depth', 'Intimacy', 'Safety', 'Acceptance'],
    lore: [
...
{
    id: 22, name: "Monogamy", cardType: "Relationship Style", visualHandle: "common_mono.jpg", primaryElement: "R", elementScores: { A: 5, I: 5, S: 5, P: 6, C: 5, R: 2 }, briefDescription: "One partner, one focused connection.", detailedDescription: "Choosing to keep it exclusive! This relationship style involves preferring or practicing having just one sexual and/or romantic partner at a time. It's about channeling relational and intimate energy into a single, often deeply committed, bond, fostering a unique shared world.", relatedIds: [23, 15, 29, 59, 76, 68], rarity: 'common', keywords: ['Structure', 'Exclusivity', 'Commitment', 'Dyad', 'One-on-One', 'Partnership', 'Focus'],
    lore: [
...
{
    id: 23, name: "Serial Monogamy", cardType: "Relationship Style", visualHandle: "common_serialmono.jpg", primaryElement: "R", elementScores: { A: 5, I: 5, S: 5, P: 5, C: 5, R: 3 }, briefDescription: "Exclusive chapters, lived one after another.", detailedDescription: "Like monogamy, but experienced in distinct sequences over time! This involves engaging in one exclusive, often committed, relationship at a time, moving from one significant partnership to the next as life unfolds. Each relationship is typically treated as primary while it lasts.", relatedIds: [22, 24], rarity: 'common', keywords: ['Structure', 'Exclusivity', 'Sequence', 'Relationship', 'Chapters', 'Transition'],
    lore: [
...
{
    id: 24, name: "Casual Sex / Hookups", cardType: "Relationship Style", visualHandle: "common_casual.jpg", primaryElement: "R", elementScores: { A: 6, I: 4, S: 6, P: 3, C: 3, R: 5 }, briefDescription: "Intimacy focused on pleasure, exploration, no strings attached.", detailedDescription: "Engaging in physical intimacy without the expectation of romantic commitment or deep emotional entanglement. Often focused on mutual pleasure, exploring chemistry, satisfying physical needs, or simply having fun. While 'casual,' ethical engagement prioritizes clear communication about boundaries and expectations (even if those expectations are 'none').", relatedIds: [23, 26, 35, 56, 65, 79, 84], rarity: 'common', keywords: ['Fleeting', 'Physical', 'Low-Commitment', 'Exploration', 'Casual', 'NSA', 'Freedom', 'Recreation', 'Pleasure-Focused'],
    lore: [
...
{
    id: 31, name: "Cuddling / Affection", cardType: "Practice/Kink", visualHandle: "common_cuddle.jpg", primaryElement: "P", elementScores: { A: 3, I: 3, S: 3, P: 6, C: 2, R: 4 }, briefDescription: "Seeking simple, warm closeness and comfort.", detailedDescription: "Pure physical closeness and shared warmth without the immediate pressure or expectation of sexual escalation. It's about seeking and giving comfort, safety, reassurance, and quiet shared presence. Sometimes the most profound intimacy is simply breathing together in a relaxed embrace, feeling safe and connected.", relatedIds: [2, 15, 48, 69, 80], rarity: 'common', keywords: ['Comfort', 'Affection', 'Security', 'Connection', 'Gentle', 'Cuddle', 'Closeness', 'Safety', 'Non-sexual', 'Soothing'],
    lore: [
...
{
    id: 32, name: "Dirty Talk", cardType: "Practice/Kink", visualHandle: "common_dirtytalk.jpg", primaryElement: "C", elementScores: { A: 5, I: 6, S: 3, P: 5, C: 7, R: 5 }, briefDescription: "Using evocative language to heighten arousal.", detailedDescription: "Intentionally using your words as a direct tool for building arousal and shaping the intimate experience! This can involve saying explicit things about desires or actions, offering suggestive commentary, giving commanding instructions, whispering sweet (or degrading) praises, or narrating fantasies. It directly engages the listener's imagination, painting pictures and building incredible heat through sound and meaning.", relatedIds: [13, 11, 4, 5, 46, 49, 66, 74, 89, 100], rarity: 'common', keywords: ['Language', 'Cognitive', 'Arousal', 'Expression', 'Fantasy', 'Verbal', 'Auditory', 'Explicit', 'Command', 'Praise'],
    lore: [
...
{
    id: 33, name: "Mutual Masturbation", cardType: "Practice/Kink", visualHandle: "common_mutualmast.jpg", primaryElement: "I", elementScores: { A: 5, I: 5, S: 6, P: 4, C: 4, R: 5 }, briefDescription: "Shared self-pleasure, side-by-side.", detailedDescription: "Partners masturbating concurrently, often in view of each other, sharing the experience visually and energetically without necessarily touching each other directly during the act. It's a unique intersection of personal focus on self-pleasure and the shared intimacy of witnessing and being witnessed.", relatedIds: [1, 18, 19, 72], rarity: 'common', keywords: ['Shared', 'Physical', 'Visual', 'Sensation', 'Masturbation', 'Voyeurism', 'Exhibitionism', 'Witnessing'],
    lore: [
...
{
    id: 46, name: "Compliments / Praise", cardType: "Practice/Kink", visualHandle: "common_praise.jpg", primaryElement: "P", elementScores: { A: 4, I: 5, S: 2, P: 7, C: 4, R: 5 }, briefDescription: "Words that uplift, affirm, and arouse.", detailedDescription: "Using positive, affirming words during intimacy or relational moments. This can range from genuine compliments on appearance or specific body parts, to praise for actions, skills, effort, or desired behaviors ('Good girl/boy/pet'). It directly nourishes feelings of desirability, confidence, and being valued.", relatedIds: [32, 15, 50, 58, 61, 10], rarity: 'common', keywords: ['Validation', 'Affirmation', 'Psychological', 'Connection', 'Confidence', 'Praise', 'Words', 'Encouragement', 'Approval'],
    lore: [
...
{
    id: 47, name: "Eye Contact", cardType: "Practice/Kink", visualHandle: "common_eyecontact.jpg", primaryElement: "P", elementScores: { A: 5, I: 6, S: 2, P: 7, C: 3, R: 6 }, briefDescription: "That intense, soul-baring gaze.", detailedDescription: "Intentionally locking eyes during intimate moments. This simple act can create incredibly intense feelings of connection, vulnerability, presence, and intimacy. It can feel like seeing directly into someone's soul, or being seen in return. It can also be used to convey power, demand attention, or signal deep focus.", relatedIds: [3, 15, 58, 89], rarity: 'common', keywords: ['Intimacy', 'Connection', 'Vulnerability', 'Presence', 'Focus', 'Eyes', 'Gaze', 'Non-verbal', 'Seeing'],
    lore: [
...
{
    id: 48, name: "Holding Hands", cardType: "Practice/Kink", visualHandle: "common_handholding.jpg", primaryElement: "P", elementScores: { A: 3, I: 4, S: 3, P: 5, C: 1, R: 4 }, briefDescription: "Simple, connected touch; quiet reassurance.", detailedDescription: "Sometimes the simplest gestures hold the most weight. Holding hands is a fundamental act of connection, conveying partnership, comfort, reassurance, and belonging, often without needing words. It's a small anchor in the world, a quiet affirmation of 'we'.", relatedIds: [2, 31, 77], rarity: 'common', keywords: ['Affection', 'Connection', 'Comfort', 'Simple', 'Touch', 'Reassurance', 'Partnership', 'Safety'],
    lore: [
...
{
    id: 49, name: "Shared Fantasy Talk", cardType: "Practice/Kink", visualHandle: "common_fantasytalk.jpg", primaryElement: "C", elementScores: { A: 5, I: 5, S: 3, P: 6, C: 6, R: 5 }, briefDescription: "Talking through fantasies together, building worlds.", detailedDescription: "Sharing your secret brain movies out loud! Partners verbally describe their fantasies, desires, or potential scenarios to each other, often building on each other's ideas. It's a way to explore possibilities, gauge interest, build arousal through imagination, and co-create a shared mental landscape.", relatedIds: [32, 14, 13, 60], rarity: 'common', keywords: ['Fantasy', 'Cognitive', 'Sharing', 'Arousal', 'Communication', 'Verbal', 'Imagination', 'Co-creation'],
    lore: [
...
{
    id: 50, name: "Validation Seeking", cardType: "Psychological/Goal", visualHandle: "common_validation.jpg", primaryElement: "P", elementScores: { A: 5, I: 6, S: 5, P: 7, C: 4, R: 5 }, briefDescription: "Needing external proof of desirability/skill.", detailedDescription: "A significant psychological driver where intimacy is sought, consciously or unconsciously, primarily to receive external confirmation of one's attractiveness, sexual skill, worthiness, or desirability. A partner's enthusiastic reaction, praise [46], or even submission can serve as this needed proof.", relatedIds: [18, 46, 91, 90], rarity: 'common', keywords: ['Validation', 'Psychological', 'Need', 'Desire', 'Performance', 'Approval', 'Worthiness', 'Mirror', 'External'],
    lore: [
...
{
    id: 51, name: "Stress Relief Focus", cardType: "Psychological/Goal", visualHandle: "common_stressrelief.jpg", primaryElement: "P", elementScores: { A: 4, I: 4, S: 5, P: 6, C: 3, R: 4 }, briefDescription: "Using sex primarily as a way to unwind and release tension.", detailedDescription: "Feeling overwhelmed or stressed out? For some, sexual activity, particularly orgasm, serves as a primary and effective go-to method for releasing physical and mental tension, calming the nervous system, and achieving a state of relaxation. The focus is less on deep connection, more on effective release.", relatedIds: [1, 56], rarity: 'common', keywords: ['Stress Relief', 'Relaxation', 'Physical', 'Catharsis', 'Coping', 'Release', 'Tension', 'Unwind'],
    lore: [
...
{
    id: 52, name: "Heterosexuality", cardType: "Orientation", visualHandle: "common_hetero.jpg", primaryElement: "A", elementScores: { A: 7, I: 5, S: 5, P: 5, C: 5, R: 5 }, briefDescription: "Primarily attracted to different gender(s).", detailedDescription: "Experiencing primary sexual and/or romantic attraction to people of a gender different from one's own (e.g., men attracted to women, women attracted to men). While often considered the societal default, it's a specific pattern on the vast spectrum of human attraction.", relatedIds: [53, 54, 55], rarity: 'common', keywords: ['Orientation', 'Gender', 'Attraction', 'Straight', 'Different Gender'],
    lore: [
...
{
    id: 53, name: "Homosexuality", cardType: "Orientation", visualHandle: "common_homo.jpg", primaryElement: "A", elementScores: { A: 7, I: 5, S: 5, P: 5, C: 5, R: 5 }, briefDescription: "Primarily attracted to the same gender(s).", detailedDescription: "Experiencing primary sexual and/or romantic attraction to people of the same or a similar gender identity as one's own (e.g., men attracted to men - Gay; women attracted to women - Lesbian). It's a specific orientation with rich cultural histories and communities.", relatedIds: [52, 54, 55], rarity: 'common', keywords: ['Orientation', 'Gender', 'Attraction', 'Gay', 'Lesbian', 'Same Gender', 'Queer'],
    lore: [
...
{
    id: 54, name: "Bisexuality", cardType: "Orientation", visualHandle: "common_bi.jpg", primaryElement: "A", elementScores: { A: 6, I: 5, S: 5, P: 5, C: 5, R: 5 }, briefDescription: "Attraction towards two or more genders.", detailedDescription: "Experiencing sexual and/or romantic attraction to more than one gender identity. This might include attraction to men and women, or attraction to one's own gender and other genders. The degree and nature of attraction can vary.", relatedIds: [52, 53, 55], rarity: 'common', keywords: ['Orientation', 'Gender', 'Attraction', 'Multiple Genders', 'Bi', 'Fluidity', 'Spectrum'],
    lore: [
...
{
    id: 55, name: "Pansexuality", cardType: "Orientation", visualHandle: "common_pan.jpg", primaryElement: "A", elementScores: { A: 5, I: 5, S: 5, P: 5, C: 5, R: 5 }, briefDescription: "Attraction regardless of gender.", detailedDescription: "Experiencing sexual and/or romantic attraction to people *regardless* of their specific gender identity or expression. The focus is often on the individual person, their personality, vibe, or connection, rather than gender being a primary factor in attraction.", relatedIds: [52, 53, 54, 103, 60], rarity: 'common', keywords: ['Orientation', 'Attraction', 'Fluidity', 'Personality', 'Pan', 'Gender-Blind', 'Connection-Focused'],
    lore: [
...
{
    id: 56, name: "Quickie", cardType: "Practice/Kink", visualHandle: "common_quickie.jpg", primaryElement: "I", elementScores: { A: 6, I: 6, S: 6, P: 3, C: 2, R: 4 }, briefDescription: "Fast, focused, and fun!", detailedDescription: "Short, sweet, and right to the point! A brief sexual encounter often characterized by minimal foreplay, high energy, and a focus on achieving orgasm or quick release efficiently. Can be spontaneous or planned when time is limited.", relatedIds: [1, 24, 79, 51], rarity: 'common', keywords: ['Brief', 'Spontaneous', 'Physical', 'Goal-Oriented', 'Fast', 'Efficient', 'Urgent'],
    lore: [
...
{
    id: 66, name: "Foreplay Focus", cardType: "Practice/Kink", visualHandle: "common_foreplay.jpg", primaryElement: "I", elementScores: { A: 5, I: 6, S: 5, P: 5, C: 4, R: 5 }, briefDescription: "Loving the delicious warm-up and build-up.", detailedDescription: "For you, the journey of arousal is just as important, if not more so, than the destination! This involves placing significant value and time on the activities leading up to intercourse or climax, like kissing [3], sensual touch [2], oral sex [67], dirty talk [32], etc. It's about savoring the anticipation.", relatedIds: [1, 2, 3, 32, 67, 83, 49], rarity: 'common', keywords: ['Build-up', 'Arousal', 'Connection', 'Intimacy', 'Anticipation', 'Warm-up', 'Teasing', 'Savoring'],
    lore: [
...
{
    id: 67, name: "Oral Sex (Giving/Receiving)", cardType: "Practice/Kink", visualHandle: "common_oral.jpg", primaryElement: "S", elementScores: { A: 6, I: 6, S: 7, P: 5, C: 3, R: 5 }, briefDescription: "Intimate pleasure using the mouth and tongue.", detailedDescription: "Engaging in sexual activity involving stimulation of the genitals (vulva, penis, anus) using the mouth, lips, and tongue. Can be focused on giving pleasure, receiving pleasure, or both simultaneously or sequentially. A common and often highly pleasurable practice for many.", relatedIds: [1, 66, 73, 107], rarity: 'common', keywords: ['Sensation', 'Physical', 'Focus', 'Giving', 'Receiving', 'Oral', 'Mouth', 'Intimacy', 'Pleasure'],
    lore: [
...
{
    id: 68, name: "Romantic Gestures", cardType: "Psychological/Goal", visualHandle: "common_romantic.jpg", primaryElement: "P", elementScores: { A: 5, I: 5, S: 3, P: 7, C: 4, R: 6 }, briefDescription: "Showing love and care outside the bedroom.", detailedDescription: "Sweet, thoughtful actions or words that aren't directly sexual but significantly boost the feeling of connection, care, and romance within a relationship. Think flowers, love notes, planning special dates [76], expressing appreciation, acts of service. These gestures nourish the emotional bond.", relatedIds: [15, 22, 31, 76, 82], rarity: 'common', keywords: ['Romance', 'Affection', 'Care', 'Relationship', 'Connection', 'Gestures', 'Thoughtfulness', 'Love Language'],
    lore: [
...
{
    id: 69, name: "Aftercare (Basic)", cardType: "Practice/Kink", visualHandle: "common_aftercare.jpg", primaryElement: "P", elementScores: { A: 4, I: 5, S: 4, P: 6, C: 3, R: 6 }, briefDescription: "Post-play connection, comfort, and check-in.", detailedDescription: "The process of checking in and providing comfort and connection after sexual activity, especially intense encounters or BDSM scenes. Can involve cuddling [31], talking, sharing water or snacks, gentle touch, reassurance, or simply quiet presence. It helps manage emotional drop and reinforces care.", relatedIds: [31, 15, 70, 80, 123, 45], rarity: 'common', keywords: ['Comfort', 'Connection', 'Care', 'Post-Scene', 'Psychological', 'Aftercare', 'Reassurance', 'Landing', 'Safety'],
    lore: [
...
{
    id: 70, name: "Pillow Talk", cardType: "Practice/Kink", visualHandle: "common_pillowtalk.jpg", primaryElement: "P", elementScores: { A: 4, I: 4, S: 2, P: 7, C: 4, R: 7 }, briefDescription: "Cozy, intimate chats after sex.", detailedDescription: "Those relaxed, often vulnerable, and deeply intimate conversations that happen after sexual activity, typically while lying close together. It's a time for sharing reflections, feelings, secrets, or simply basking in the afterglow connection.", relatedIds: [69, 15], rarity: 'common', keywords: ['Intimacy', 'Conversation', 'Vulnerability', 'Connection', 'Post-Scene', 'Talk', 'Sharing', 'Reflection'],
    lore: [
...
{
    id: 71, name: "Shower/Bath Sex", cardType: "Practice/Kink", visualHandle: "common_showersex.jpg", primaryElement: "S", elementScores: { A: 5, I: 5, S: 6, P: 4, C: 3, R: 5 }, briefDescription: "Getting wet 'n' wild, literally!", detailedDescription: "Taking the intimate fun into the shower or bathtub! Adds the unique sensory elements of water temperature, slipperiness (pro and con!), steam, and the enclosed environment. Can feel playful, convenient, or intensely intimate.", relatedIds: [1], rarity: 'common', keywords: ['Sensation', 'Environment', 'Water', 'Playful', 'Shower', 'Bath', 'Wet', 'Sensory'],
    lore: [
...
{
    id: 72, name: "Using Sex Toys (Simple)", cardType: "Practice/Kink", visualHandle: "common_toys_simple.jpg", primaryElement: "S", elementScores: { A: 5, I: 5, S: 6, P: 4, C: 3, R: 4 }, briefDescription: "Adding some buzz, bounce, or targeted sensation.", detailedDescription: "Bringing in the basics to enhance pleasure! Using common, relatively uncomplicated toys like simple vibrators (wand, bullet, rabbit), dildos, or butt plugs to add new sensations, target specific areas, or facilitate certain acts.", relatedIds: [1, 33, 73, 112], rarity: 'common', keywords: ['Toys', 'Sensation', 'Stimulation', 'Physical', 'Vibrator', 'Dildo', 'Enhancement', 'Tools'],
    lore: [
...
{
    id: 73, name: "Lubricant Use", cardType: "Practice/Kink", visualHandle: "common_lube.jpg", primaryElement: "S", elementScores: { A: 4, I: 4, S: 5, P: 3, C: 2, R: 4 }, briefDescription: "Making things slide smoothly for comfort and pleasure.", detailedDescription: "Using personal lubricant to reduce friction during sexual activity (penetrative or manual). Essential for comfort with certain acts or anatomy, prevents chafing, allows for longer/more intense play, and can enhance sensation.", relatedIds: [1, 67, 72, 107, 108], rarity: 'common', keywords: ['Comfort', 'Sensation', 'Physical', 'Practical', 'Lube', 'Friction', 'Smoothness', 'Enhancement'],
    lore: [
...
{
    id: 74, name: "Flirting / Banter", cardType: "Interaction", visualHandle: "common_flirt.jpg", primaryElement: "I", elementScores: { A: 6, I: 7, S: 3, P: 5, C: 6, R: 5 }, briefDescription: "Playful, witty chat that sparks interest.", detailedDescription: "That fun, often lighthearted, back-and-forth verbal dance! Using suggestive comments, playful teasing, witty remarks, compliments, or double entendres to signal interest, build rapport, test compatibility [P], and create a spark of attraction [A] or playful tension.", relatedIds: [32, 60, 75, 49, 81], rarity: 'common', keywords: ['Playful', 'Communication', 'Cognitive', 'Attraction', 'Rapport', 'Banter', 'Flirt', 'Teasing', 'Wit', 'Interaction'],
    lore: [
...
{
    id: 75, name: "Shared Humor", cardType: "Psychological/Goal", visualHandle: "common_humor.jpg", primaryElement: "P", elementScores: { A: 5, I: 6, S: 2, P: 6, C: 5, R: 6 }, briefDescription: "Finding connection and joy through laughter.", detailedDescription: "Finding deep connection and comfort through shared giggles and jokes! Enjoying silly moments together, appreciating the same kinds of wit, or using humor to navigate awkwardness diffuses tension and builds a strong sense of camaraderie and psychological [P] ease.", relatedIds: [74, 15], rarity: 'common', keywords: ['Humor', 'Connection', 'Playful', 'Psychological', 'Lightness', 'Laughter', 'Rapport', 'Joy'],
    lore: [
...
{
    id: 76, name: "Date Nights", cardType: "Relationship Style", visualHandle: "common_datenight.jpg", primaryElement: "R", elementScores: { A: 4, I: 5, S: 4, P: 6, C: 4, R: 5 }, briefDescription: "Making dedicated time for connection.", detailedDescription: "Intentionally setting aside specific, dedicated time for partner(s) to connect, focus on each other, and nurture the relationship, away from daily distractions. It's a conscious effort to prioritize the bond and create shared positive experiences.", relatedIds: [68, 15, 22], rarity: 'common', keywords: ['Relationship', 'Connection', 'Ritual', 'Intimacy', 'Date', 'Quality Time', 'Prioritization', 'Maintenance'],
    lore: [
...
{
    id: 77, name: "Public Display Affection (Mild)", cardType: "Practice/Kink", visualHandle: "common_pda.jpg", primaryElement: "R", elementScores: { A: 4, I: 5, S: 3, P: 5, C: 2, R: 5 }, briefDescription: "Subtle affection shown out and about.", detailedDescription: "Showing you're connected or partnered while in public, but keeping it relatively low-key and socially acceptable. Think holding hands [48], a quick kiss [3], an arm around the shoulder or waist. It affirms the bond without drawing excessive attention.", relatedIds: [48, 3, 78, 68], rarity: 'common', keywords: ['Public', 'Affection', 'Subtle', 'Relationship', 'PDA', 'Connection', 'Gesture'],
    lore: [
...
{
    id: 79, name: "Spontaneity Seeker", cardType: "Psychological/Goal", visualHandle: "common_spontaneity.jpg", primaryElement: "P", elementScores: { A: 6, I: 6, S: 6, P: 5, C: 3, R: 5 }, briefDescription: "Loving the thrill of the unexpected!", detailedDescription: "Getting a special kick and heightened excitement from unplanned, impulsive, or surprising intimate moments. Breaking routine, seizing the moment, and the element of unexpectedness itself provides a significant psychological [P] boost.", relatedIds: [56, 24], rarity: 'common', keywords: ['Spontaneous', 'Excitement', 'Unpredictable', 'Physical', 'Surprise', 'Impulsive', 'Thrill'],
    lore: [
...
{
    id: 80, name: "Comfort Seeker", cardType: "Psychological/Goal", visualHandle: "common_comfort.jpg", primaryElement: "P", elementScores: { A: 3, I: 3, S: 4, P: 7, C: 2, R: 4 }, briefDescription: "Seeking safety, soothing touch, and reassurance.", detailedDescription: "Craving physical closeness primarily for the profound feelings of safety, security, reassurance, and being cared for. The main psychological [P] driver is often about soothing the nervous system, finding refuge, or feeling emotionally held, rather than intense arousal.", relatedIds: [31, 2, 69, 15], rarity: 'common', keywords: ['Comfort', 'Security', 'Psychological', 'Affection', 'Soothing', 'Safe', 'Reassurance', 'Refuge', 'Nurturing'],
    lore: [
...
{
    id: 81, name: "Attraction to Confidence", cardType: "Orientation", visualHandle: "common_attr_conf.jpg", primaryElement: "A", elementScores: { A: 7, I: 6, S: 4, P: 6, C: 5, R: 5 }, briefDescription: "Drawn to self-assuredness and presence.", detailedDescription: "Finding someone who knows what they want, carries themselves with assurance, speaks clearly, and projects an air of capability or self-possession inherently attractive [A]. This confidence often translates into perceived leadership potential or competence.", relatedIds: [4, 60, 74, 90], rarity: 'common', keywords: ['Attraction', 'Confidence', 'Power', 'Personality', 'Assertive', 'Self-assured', 'Presence', 'Capability'],
    lore: [
...
{
    id: 82, name: "Attraction to Kindness", cardType: "Orientation", visualHandle: "common_attr_kind.jpg", primaryElement: "A", elementScores: { A: 5, I: 4, S: 4, P: 7, C: 4, R: 6 }, briefDescription: "A genuinely kind heart is inherently hot.", detailedDescription: "Being deeply drawn to people who demonstrate genuine kindness, empathy, compassion, and consideration for others. This quality signals emotional intelligence, safety [P], and the potential for a nurturing, supportive connection [R], making it a powerful attraction [A] point.", relatedIds: [15, 58, 68, 80], rarity: 'common', keywords: ['Attraction', 'Kindness', 'Empathy', 'Connection', 'Personality', 'Nurturing', 'Compassion', 'Safety', 'Character'],
    lore: [
...
{
    id: 83, name: "Slow Burn", cardType: "Practice/Kink", visualHandle: "common_slowburn.jpg", primaryElement: "P", elementScores: { A: 5, I: 5, S: 5, P: 7, C: 5, R: 6 }, briefDescription: "Relishing the delicious build-up and anticipation.", detailedDescription: "Loving the journey, not just the destination! Preferring a gradual, deliberate build-up of tension, intimacy, and arousal over time, rather than rushing towards a climax. Savoring the anticipation, the subtle shifts in energy, and the deepening connection [P] is the core pleasure.", relatedIds: [15, 66, 38, 2, 47], rarity: 'common', keywords: ['Anticipation', 'Intimacy', 'Tension', 'Psychological', 'Pacing', 'Build-up', 'Savoring', 'Gradual'],
    lore: [
...
{
    id: 85, name: "Make-up Sex", cardType: "Psychological/Goal", visualHandle: "common_makeupsex.jpg", primaryElement: "P", elementScores: { A: 6, I: 6, S: 6, P: 7, C: 3, R: 5 }, briefDescription: "Post-argument passion and reconciliation.", detailedDescription: "Engaging in passionate sexual activity following a fight, disagreement, or period of conflict. The heightened emotions, adrenaline, and subsequent relief of reconciliation can sometimes translate into unusually intense arousal and a powerful need to reconnect physically.", relatedIds: [3], rarity: 'common', keywords: ['Emotion', 'Intensity', 'Reconciliation', 'Catharsis', 'Conflict', 'Passion', 'Reconnection'],
    lore: [
...
{
id: 5, name: "Submission (Psychological)", cardType: "Identity/Role", visualHandle: "uncommon_sub_art.jpg", primaryElement: "I", elementScores: { A: 6, I: 1, S: 5, P: 8, C: 5, R: 6 }, briefDescription: "Finding joy and freedom in yielding control.", detailedDescription: "Discovering genuine joy, profound relief, deep fulfillment, or exquisite peace in the act of consensually handing over the reins of control, primarily on a mental and emotional level. This can manifest in myriad ways: eagerly following clear directions [11], finding purpose and pleasure in serving [10] a partner's needs, placing implicit trust in their decisions and guidance, or simply reveling in the delicious, liberating feeling of letting go of constant analysis and responsibility.", relatedIds: [4, 6, 17, 10, 12, 37, 39, 58, 61, 63, 87, 91, 98, 99, 109, 119, 123, 117], rarity: 'uncommon', keywords: ['Surrender', 'Power', 'Following', 'Psychological', 'Obedience', 'Trust', 'Vulnerability', 'Submission', 'Yielding', 'Service', 'Letting Go', 'Receiving'],
lore: [
...
{
id: 6, name: "Switching", cardType: "Identity/Role", visualHandle: "uncommon_switch.jpg", primaryElement: "I", elementScores: { A: 6, I: 5, S: 6, P: 7, C: 6, R: 6 }, briefDescription: "Enjoying both leading and following roles fluidly.", detailedDescription: "Why choose just one side of the dynamic coin when both offer unique pleasures? Switches find satisfaction, excitement, and fulfillment in fluidly shifting between leading (Dominant [4]) and following (submissive [5]) roles or energies within their intimate dynamics. They appreciate and often seek out the distinct perspectives, challenges, sensations, and satisfactions offered by both positions, reveling in the flexibility, contrast, and dynamic tension.", relatedIds: [4, 5, 89], rarity: 'uncommon', keywords: ['Fluidity', 'Power', 'Interaction', 'Versatility', 'Role', 'Switch', 'Adaptable', 'Both Sides', 'Dynamic'],
lore: [
...
{
id: 7, name: "Impact Play (Light)", cardType: "Practice/Kink", visualHandle: "uncommon_impact_light_art.jpg", primaryElement: "S", elementScores: { A: 5, I: 6, S: 6, P: 5, C: 4, R: 5 }, briefDescription: "Playful taps, swats, and delightfully stingy sensations.", detailedDescription: "Introducing the element of physical impact, but keeping it relatively gentle, often playful, and focused on sensation rather than pain tolerance. Think deliberate spanking with the open hand, light slapping that leaves a warm blush, using softer implements like riding crops, thin canes, or fuzzy paddles. The primary focus is usually on fun, stimulating sensation, creating an interesting rhythm, bringing awareness to the skin, or enacting light power dynamics, rather than pushing limits or causing intense pain.", relatedIds: [8, 9, 4, 5, 40, 57, 93, 96], rarity: 'uncommon', keywords: ['Impact', 'Sensation', 'Physical', 'Playful', 'Rhythm', 'Spanking', 'Light', 'Sting', 'Teasing', 'Swatting', 'Awakening'],
lore: [
...
{
    id: 10, name: "Service Submission", cardType: "Psychological/Goal", visualHandle: "uncommon_service.jpg", primaryElement: "I", elementScores: { A: 5, I: 2, S: 4, P: 7, C: 4, R: 6 }, briefDescription: "Finding joy and purpose in taking care of another.", detailedDescription: "A specific flavor of submission [5] where the primary thrill, purpose, and psychological [P] fulfillment comes from performing acts of service for a dominant partner [4]. This could range from simple tasks like fetching drinks or giving massages, to more elaborate rituals, anticipating needs, or maintaining household order, all done with an attitude of devotion and care.", relatedIds: [5, 4, 11, 58, 61, 98, 109, 46], rarity: 'uncommon', keywords: ['Service', 'Submission', 'Psychological', 'Devotion', 'Power', 'Care', 'Purpose', 'Anticipation', 'Acts of Service'],
    lore: [
...
{
    id: 13, name: "Role-Playing (Scenario)", cardType: "Practice/Kink", visualHandle: "uncommon_roleplay.jpg", primaryElement: "C", elementScores: { A: 6, I: 6, S: 5, P: 6, C: 8, R: 6 }, briefDescription: "Playing specific characters or situations in scenes.", detailedDescription: "Let's pretend! Consciously adopting specific roles, characters, or personas within an agreed-upon scenario or setting for intimate play. This engages the Cognitive [C] element strongly, allowing exploration of different dynamics, power structures [I], fantasies, or aspects of self in a contained, imaginative space.", relatedIds: [14, 30, 21, 39, 64, 92, 98, 101, 117, 121, 43, 49, 32], rarity: 'uncommon', keywords: ['Role-Play', 'Cognitive', 'Fantasy', 'Scenario', 'Character', 'Pretend', 'Imagination', 'Storytelling', 'Persona'],
    lore: [
...
{
    id: 18, name: "Exhibitionism", cardType: "Identity/Role", visualHandle: "uncommon_exhibit.jpg", primaryElement: "I", elementScores: { A: 6, I: 7, S: 5, P: 7, C: 6, R: 5 }, briefDescription: "Loving the thrill of an audience.", detailedDescription: "Deriving significant arousal or pleasure from the act of being watched during intimate or vulnerable moments. The awareness of an audience (one person or many, known or anonymous) is a key component of the excitement. This often connects to needs for validation [50], performance [90/91], or the thrill of potential discovery/taboo.", relatedIds: [19, 12, 34, 50, 78, 90, 91, 105, 33], rarity: 'uncommon', keywords: ['Performance', 'Visual', 'Public', 'Arousal', 'Validation', 'Exhibitionist', 'Watching', 'Audience', 'Thrill', 'Risk'],
    lore: [
...
{
    id: 19, name: "Voyeurism", cardType: "Identity/Role", visualHandle: "uncommon_voyeur.jpg", primaryElement: "A", elementScores: { A: 7, I: 2, S: 3, P: 6, C: 5, R: 3 }, briefDescription: "Finding arousal in watching others.", detailedDescription: "Experiencing significant sexual arousal or interest primarily from secretly or consensually watching others engage in intimate acts or states of undress. The distance, the secrecy (if applicable), and the focus on observation are key elements. It's about the power and pleasure found in looking.", relatedIds: [18, 12, 34, 105, 118, 33], rarity: 'uncommon', keywords: ['Observation', 'Visual', 'Arousal', 'Distance', 'Secret', 'Watching', 'Voyeur', 'Looking', 'Power'],
    lore: [
...
{
    id: 26, name: "Open Relationship", cardType: "Relationship Style", visualHandle: "uncommon_openrel.jpg", primaryElement: "R", elementScores: { A: 6, I: 5, S: 6, P: 5, C: 5, R: 7 }, briefDescription: "Primary couple, with freedom for outside connections.", detailedDescription: "A relationship structure, typically involving a primary couple (dyad), where both partners explicitly agree that one or both may have sexual or sometimes romantic relationships with other people. Rules, boundaries, and communication styles vary widely but are key to navigating this ethically.", relatedIds: [24, 25, 27, 35, 84], rarity: 'uncommon', keywords: ['Non-Monogamy', 'Structure', 'Rules', 'Openness', 'Dyad', 'CNM', 'ENM', 'Communication', 'Boundaries'],
    lore: [
...
{
    id: 28, name: "Asexuality", cardType: "Orientation", visualHandle: "uncommon_ace.jpg", primaryElement: "A", elementScores: { A: 0, I: 3, S: 2, P: 3, C: 3, R: 4 }, briefDescription: "Experiencing little to no sexual attraction.", detailedDescription: "Characterized by experiencing little to no inherent sexual attraction towards any gender. Asexuality exists on a spectrum (Ace Spectrum) with variations like gray-asexuality (rare/low attraction) or demisexuality [29] (attraction only after bond). It's distinct from celibacy (a choice) or low libido (a physiological state). Aces can still experience romantic attraction [36], enjoy sensual touch [2], and form deep intimate bonds [15].", relatedIds: [29, 36, 59], rarity: 'uncommon', keywords: ['Asexuality', 'Orientation', 'Attraction', 'Spectrum', 'Ace', 'Lack of Attraction', 'Gray-Ace'],
    lore: [
...
{
    id: 29, name: "Demisexuality", cardType: "Orientation", visualHandle: "uncommon_demi.jpg", primaryElement: "A", elementScores: { A: 3, I: 4, S: 4, P: 8, C: 5, R: 5 }, briefDescription: "Attraction sparks only after deep emotional connection.", detailedDescription: "An orientation on the Asexuality spectrum where sexual attraction [A] only develops *after* a strong emotional bond [P] has been formed with a specific person. The emotional connection acts as a necessary prerequisite or key to unlocking potential sexual desire; without it, attraction doesn't typically arise.", relatedIds: [15, 28, 22], rarity: 'uncommon', keywords: ['Demisexuality', 'Attraction', 'Connection', 'Emotion', 'Intimacy', 'Bond', 'Prerequisite', 'Ace Spectrum'],
    lore: [
...
{
    id: 35, name: "Swinging", cardType: "Relationship Style", visualHandle: "uncommon_swing.jpg", primaryElement: "R", elementScores: { A: 5, I: 5, S: 6, P: 4, C: 4, R: 7 }, briefDescription: "Committed couples engaging in recreational sex with others.", detailedDescription: "A form of consensual non-monogamy where committed couples agree to engage in sexual activities with other individuals or couples, often together in the same location (e.g., partner swapping at parties). Typically emphasizes recreational sex rather than deep emotional connections with outside partners.", relatedIds: [26, 24, 34], rarity: 'uncommon', keywords: ['Non-Monogamy', 'Recreation', 'Couple', 'Group', 'Social', 'Swinger', 'Lifestyle', 'Partner Swapping'],
    lore: [
...
{
    id: 36, name: "Aromanticism", cardType: "Orientation", visualHandle: "uncommon_aro.jpg", primaryElement: "A", elementScores: { A: 2, I: 3, S: 3, P: 4, C: 4, R: 3 }, briefDescription: "Experiencing little to no romantic attraction.", detailedDescription: "Characterized by experiencing little or no innate romantic attraction towards others, regardless of gender. Like asexuality [28], aromanticism exists on a spectrum (Aro Spectrum). Aromantic individuals can still experience sexual attraction, form deep platonic bonds [59], desire partnership, and value intimacy, just not through the lens of traditional romance.", relatedIds: [28, 27, 59], rarity: 'uncommon', keywords: ['Aromanticism', 'Orientation', 'Romance', 'Spectrum', 'Aro', 'Lack of Attraction', 'Platonic', 'QPR'],
    lore: [
...
{
    id: 37, name: "Sensory Deprivation (Light)", cardType: "Practice/Kink", visualHandle: "uncommon_sensdep.jpg", primaryElement: "S", elementScores: { A: 4, I: 3, S: 7, P: 6, C: 5, R: 5 }, briefDescription: "Turning down some senses (e.g., blindfolds!) to heighten others.", detailedDescription: "Using simple tools like blindfolds, earplugs, or hoods to temporarily block out or significantly reduce input from one or more key senses (usually sight or sound). This often heightens awareness of the remaining senses (touch, smell, internal sensations), increases vulnerability [P], and shifts mental focus [C].", relatedIds: [9, 17, 5, 57, 44, 86, 124, 16], rarity: 'uncommon', keywords: ['Sensory Deprivation', 'Sensation', 'Focus', 'Vulnerability', 'Psychological', 'Blindfold', 'Heighten', 'Awareness'],
    lore: [
...
{
    id: 39, name: "Age Play", cardType: "Practice/Kink", visualHandle: "uncommon_ageplay.jpg", primaryElement: "C", elementScores: { A: 5, I: 6, S: 4, P: 7, C: 8, R: 6 }, briefDescription: "Role-playing different ages within a dynamic.", detailedDescription: "Consensual role-play [13] where participants adopt personas and behaviors associated with ages different from their chronological age. Often involves a Caregiver/Little dynamic [58] but can explore various age combinations. Focuses on themes of nurturing, dependence, control [4/5], regression, or exploring different emotional states [P]. (Must be strictly consensual play between adults).", relatedIds: [13, 4, 5, 10, 58, 92, 98], rarity: 'uncommon', keywords: ['Age Play', 'Role-Play', 'Cognitive', 'Psychological', 'Dynamic', 'CGL', 'Regression', 'Nurturing', 'Dependence'],
    lore: [
...
{
    id: 40, name: "Primal Play", cardType: "Practice/Kink", visualHandle: "uncommon_primal_art.jpg", primaryElement: "I", elementScores: { A: 5, I: 8, S: 7, P: 6, C: 3, R: 5 }, briefDescription: "Tapping into raw, instinctive, animalistic energy.", detailedDescription: "Engaging in intimate play that bypasses higher cognitive functions [C] to tap into more raw, animalistic, or instinctive energies. Often involves less talk, more non-verbal communication (growls, nips, wrestling, chasing), focus on scent and raw sensation [S], and exploration of predator/prey or territorial dynamics [I].", relatedIds: [4, 5, 9, 7, 8, 97, 98], rarity: 'uncommon', keywords: ['Primal', 'Instinct', 'Interaction', 'Physical', 'Animalistic', 'Non-verbal', 'Raw', 'Energetic', 'Chase'],
    lore: [
...
{
    id: 57, name: "Sensory Enhancement", cardType: "Practice/Kink", visualHandle: "uncommon_sensenh.jpg", primaryElement: "S", elementScores: { A: 4, I: 5, S: 7, P: 5, C: 4, R: 5}, briefDescription: "Turning up the volume on specific physical feelings.", detailedDescription: "Using specific tools, substances (like warming/cooling lubes [73]), or techniques to intentionally amplify or sharpen specific physical sensations. This could involve things like using textured tools, vibration [72], temperature play [88], or focusing techniques to make targeted feelings 'pop' and dominate awareness.", relatedIds: [2, 37, 7, 9, 86, 88, 102, 112], rarity: 'uncommon', keywords: ['Sensation', 'Focus', 'Enhancement', 'Physical', 'Tools', 'Amplify', 'Intensity', 'Awareness'],
    lore: [
...
{
    id: 58, name: "Caregiver/Little Dynamics (CG/l)", cardType: "Psychological/Goal", visualHandle: "uncommon_cglg.jpg", primaryElement: "P", elementScores: { A: 5, I: 7, S: 4, P: 8, C: 6, R: 7 }, briefDescription: "Nurturing/dependent role-play for comfort or control.", detailedDescription: "A consensual dynamic where one person (the Caregiver - CG) takes on a nurturing, guiding, sometimes disciplinary role towards another person (the little - l) who embodies a younger, more dependent or regressed persona [39]. Addresses needs [P] for safety, structure, care, release from adult responsibility, or specific power dynamics [I]. Includes variations like DD/lg (Daddy Dom/little girl), MD/lb (Mommy Dom/little boy), etc.", relatedIds: [39, 4, 5, 10, 15, 82, 47, 46], rarity: 'uncommon', keywords: ['Caregiver', 'Nurturing', 'Dependence', 'Role-Play', 'Psychological', 'Vulnerability', 'CGL', 'DDlg', 'MDlb', 'Age Play', 'Safety', 'Structure'],
    lore: [
...
{
    id: 59, name: "Platonic Partnership / QPR", cardType: "Relationship Style", visualHandle: "uncommon_qpr.jpg", primaryElement: "R", elementScores: { A: 3, I: 4, S: 3, P: 7, C: 5, R: 6 }, briefDescription: "Intensely close, committed, non-romantic bond.", detailedDescription: "Like best friends turned up to 11, but with a level of commitment often associated with romance! Queerplatonic Relationships (QPRs) or Partnerships are deeply committed, intimate bonds that intentionally exist outside the traditional framework of romantic love. They prioritize platonic connection, mutual support, and shared life, potentially involving cohabitation or shared finances, without necessarily including romantic or sexual elements (though sex can sometimes be present depending on the individuals).", relatedIds: [22, 36, 15, 27, 25, 84], rarity: 'uncommon', keywords: ['Platonic', 'Commitment', 'Intimacy', 'Relationship', 'Non-Romantic', 'QPR', 'Partnership', 'Aro Spectrum', 'Chosen Family'],
    lore: [
...
{
    id: 60, name: "Sapiosexuality", cardType: "Orientation", visualHandle: "uncommon_sapio.jpg", primaryElement: "A", elementScores: { A: 7, I: 5, S: 3, P: 6, C: 8, R: 5 }, briefDescription: "Finding intelligence incredibly sexy!", detailedDescription: "An orientation where intelligence, wit, intellectual curiosity, or the way someone thinks is the primary and most potent trigger for sexual and/or romantic attraction [A]. The cognitive [C] connection and stimulation are paramount, often outweighing physical appearance or other common factors.", relatedIds: [49, 74, 81, 55], rarity: 'uncommon', keywords: ['Sapiosexual', 'Attraction', 'Intelligence', 'Cognitive', 'Mind', 'Brains', 'Wit', 'Intellect', 'Curiosity'],
    lore: [
...
{
    id: 61, name: "Body Worship", cardType: "Practice/Kink", visualHandle: "uncommon_bodyworship.jpg", primaryElement: "P", elementScores: { A: 6, I: 4, S: 6, P: 8, C: 3, R: 6 }, briefDescription: "Adoring and venerating a partner's physical form.", detailedDescription: "Showing focused, often reverent, appreciation and adoration for a partner's body or specific parts of it. This can involve slow, sensual touch [2], kissing, licking, massage, verbal praise [46], or simply focused gazing [47], all performed with an attitude of worship or deep admiration. It often meets psychological needs [P] for validation and feeling cherished.", relatedIds: [5, 10, 12, 62, 102, 46, 2], rarity: 'uncommon', keywords: ['Worship', 'Devotion', 'Adoration', 'Psychological', 'Focus', 'Body', 'Appreciation', 'Validation', 'Reverence', 'Sensual'],
    lore: [
...
{
    id: 62, name: "Foot Fetish / Podophilia", cardType: "Orientation", visualHandle: "uncommon_footfetish.jpg", primaryElement: "A", elementScores: { A: 8, I: 4, S: 7, P: 5, C: 3, R: 4 }, briefDescription: "Finding feet uniquely fascinating and arousing!", detailedDescription: "A specific sexual interest (paraphilia or fetish) where feet act as a primary and significant trigger for sexual arousal [A]. This can involve attraction to the appearance, smell, feel, or taste of feet, or enjoyment derived from activities like foot massage, kissing, licking, or incorporating feet into other sexual acts.", relatedIds: [61, 12, 102], rarity: 'uncommon', keywords: ['Fetish', 'Feet', 'Attraction', 'Focus', 'Sensation', 'Podophilia', 'Worship', 'Sensory', 'Paraphilia'],
    lore: [
...
{
    id: 78, name: "Public Display Affection (Moderate)", cardType: "Practice/Kink", visualHandle: "uncommon_pda_mod.jpg", primaryElement: "R", elementScores: { A: 5, I: 6, S: 4, P: 6, C: 3, R: 6 }, briefDescription: "Getting a little bolder with affection in public spaces.", detailedDescription: "Turning up the heat slightly on public affection, perhaps moving beyond simple hand-holding [77] to more noticeable embraces, passionate kissing [3], or touches that might draw some attention but still generally fall within broader social acceptability (depending on location/culture). Often involves a slight thrill of risk or exhibitionism [18].", relatedIds: [77, 18, 3], rarity: 'uncommon', keywords: ['Public', 'Exhibitionism', 'Risk', 'Thrill', 'Affection', 'PDA', 'Bold', 'Noticeable', 'Kissing'],
    lore: [
...
{
    id: 84, name: "Solo Polyamory", cardType: "Relationship Style", visualHandle: "uncommon_solopoly.jpg", primaryElement: "R", elementScores: { A: 5, I: 5, S: 5, P: 6, C: 6, R: 7 }, briefDescription: "Practicing polyamory while maintaining an independent life.", detailedDescription: "Actively practicing polyamory [25] (engaging in multiple ethical, loving, and intimate relationships simultaneously) but choosing to live independently and prioritize personal autonomy. Solo poly individuals typically don't cohabitate with partners or aim for traditional relationship escalator milestones (marriage, merging finances), valuing their independence alongside their connections.", relatedIds: [25, 27, 24, 59], rarity: 'uncommon', keywords: ['Polyamory', 'Non-Monogamy', 'Autonomy', 'Independence', 'Structure', 'SoloPoly', 'CNM', 'ENM', 'Self-Partnered'],
    lore: [
...
{
    id: 86, name: "Sensory Overload", cardType: "Practice/Kink", visualHandle: "uncommon_sens_overload.jpg", primaryElement: "S", elementScores: { A: 5, I: 6, S: 8, P: 6, C: 4, R: 5 }, briefDescription: "Intense, multi-sensory input leading to altered states.", detailedDescription: "Intentionally bombarding multiple senses simultaneously with strong, potentially overwhelming stimuli (e.g., loud music, strobe lights, intense smells, multiple types of touch/vibration/impact). The goal is often to push past cognitive processing [C] into a more reactive, altered state ('subspace' or 'overload'), potentially leading to release [P] or disorientation.", relatedIds: [37, 57, 8, 124, 9, 44], rarity: 'uncommon', keywords: ['Sensory Overload', 'Intensity', 'Sensation', 'Altered State', 'Psychological', 'Overwhelm', 'BDSM', 'Subspace', 'Disorientation'],
    lore: [
...
{
    id: 87, name: "Light Bondage (Cuffs/Silk)", cardType: "Practice/Kink", visualHandle: "uncommon_bond_light_art.jpg", primaryElement: "S", elementScores: { A: 5, I: 5, S: 6, P: 6, C: 4, R: 5 }, briefDescription: "Simple, often playful tying or restraint.", detailedDescription: "Using relatively simple, easy-to-use restraints like handcuffs (metal or fuzzy), silk scarves, soft rope, or leather cuffs to gently restrict movement. Often focuses on the psychological [P] feeling of helplessness [17], enhancing sensation [S] in specific areas by limiting movement, playful power dynamics [I], or aesthetic appeal.", relatedIds: [16, 17, 5, 93], rarity: 'uncommon', keywords: ['Bondage', 'Restriction', 'Playful', 'Sensation', 'Power', 'Cuffs', 'Ties', 'Light', 'Helplessness', 'Aesthetic'],
    lore: [
...
{
    id: 89, name: "Power Play (Subtle)", cardType: "Psychological/Goal", visualHandle: "uncommon_power_subtle.jpg", primaryElement: "P", elementScores: { A: 6, I: 7, S: 5, P: 7, C: 7, R: 6 }, briefDescription: "Enjoying the nuanced undercurrents of influence and control.", detailedDescription: "Getting a distinct psychological [P] kick or intellectual [C] stimulation from noticing, navigating, and playing with the subtle, often unspoken, shifts and negotiations of power, influence, and control that exist within intimate interactions [I]. It's less about overt commands [11], more about suggestion, nuance, and reading the energy.", relatedIds: [4, 5, 11, 90, 6, 47, 32], rarity: 'uncommon', keywords: ['Power', 'Subtle', 'Psychological', 'Dynamic', 'Negotiation', 'Cognitive', 'Influence', 'Undercurrents', 'Suggestion', 'Reading'],
    lore: [
...
{
    id: 90, name: "Performance Focus (Top)", cardType: "Identity/Role", visualHandle: "uncommon_perf_top.jpg", primaryElement: "I", elementScores: { A: 5, I: 8, S: 6, P: 7, C: 6, R: 5 }, briefDescription: "Finding satisfaction in skillfully orchestrating pleasure/sensation.", detailedDescription: "A Dominant [4] or Top interaction style [I] where a significant part of the satisfaction comes from skillfully *performing* the role – expertly delivering pleasure, precisely controlling sensation [S], orchestrating the scene flawlessly, and often, witnessing the partner's intense reaction as proof [P] of their skill.", relatedIds: [4, 11, 18, 89, 50], rarity: 'uncommon', keywords: ['Performance', 'Control', 'Pleasure', 'Skill', 'Validation', 'Leading', 'Top', 'Orchestration', 'Execution', 'Reaction'],
    lore: [
...
{
    id: 91, name: "Performance Focus (Bottom)", cardType: "Identity/Role", visualHandle: "uncommon_perf_bot.jpg", primaryElement: "I", elementScores: { A: 5, I: 3, S: 6, P: 7, C: 5, R: 5 }, briefDescription: "Finding satisfaction in clearly showing reactions and pleasure.", detailedDescription: "A Submissive [5] or Bottom interaction style [I] where a significant part of the enjoyment comes from clearly and perhaps dramatically *expressing* reactions to stimulation or commands. Showing pleasure, pain, or struggle vividly can be a way of participating, validating [50] the Top's efforts, and amplifying the scene's energy.", relatedIds: [5, 18, 50], rarity: 'uncommon', keywords: ['Performance', 'Reaction', 'Expression', 'Pleasure', 'Validation', 'Following', 'Bottom', 'Responsive', 'Amplification'],
    lore: [
...
{
    id: 92, name: "Gender Play", cardType: "Practice/Kink", visualHandle: "uncommon_genderplay.jpg", primaryElement: "C", elementScores: { A: 6, I: 6, S: 4, P: 6, C: 7, R: 5 }, briefDescription: "Playfully exploring or subverting gender roles/expression.", detailedDescription: "Consensually playing with, exaggerating, or subverting traditional gender roles, expressions, or presentations within an intimate or role-play [13] context. This can involve cross-dressing, adopting mannerisms associated with a different gender, exploring non-binary expressions, or playing with the power dynamics [I] associated with gender stereotypes.", relatedIds: [13, 39, 103, 4, 5, 21], rarity: 'uncommon', keywords: ['Gender', 'Role-Play', 'Cognitive', 'Expression', 'Fluidity', 'Cross-dressing', 'Subversion', 'Identity', 'Presentation'],
    lore: [
...
{
    id: 93, name: "Tickling (Erotic)", cardType: "Practice/Kink", visualHandle: "uncommon_tickle.jpg", primaryElement: "S", elementScores: { A: 4, I: 6, S: 6, P: 5, C: 3, R: 5 }, briefDescription: "Using tickling as playful 'torture' or sensation play.", detailedDescription: "Intentionally using tickling not just for brief laughs, but as a form of playful 'torture,' teasing, sensation play [S], or even a tool within power dynamics [I]. Often involves targeting sensitive areas and can elicit intense, involuntary reactions (laughter, squirming), which can be part of the appeal for both partners.", relatedIds: [7, 38, 87], rarity: 'uncommon', keywords: ['Tickling', 'Playful', 'Sensation', 'Control', 'Teasing', 'Torture', 'Involuntary', 'Laughter', 'Squirming'],
    lore: [
...
{
    id: 94, name: "Leather Fetish", cardType: "Orientation", visualHandle: "uncommon_leather.jpg", primaryElement: "A", elementScores: { A: 8, I: 6, S: 7, P: 6, C: 5, R: 5 }, briefDescription: "Finding leather inherently and powerfully attractive.", detailedDescription: "A specific fetish where sexual arousal [A] is significantly and primarily triggered by the sight, smell, sound, or feel of leather clothing or gear. The material itself, and its associated connotations (power, toughness, luxury, specific subcultures), acts as a potent erotic catalyst.", relatedIds: [20, 21, 4, 12], rarity: 'uncommon', keywords: ['Fetish', 'Leather', 'Material', 'Attraction', 'Sensation', 'Subculture', 'Gear', 'Smell', 'Texture', 'Power'],
    lore: [
...
{
    id: 98, name: "Pet Play", cardType: "Practice/Kink", visualHandle: "uncommon_petplay.jpg", primaryElement: "C", elementScores: { A: 5, I: 6, S: 5, P: 7, C: 7, R: 6 }, briefDescription: "Role-playing as animals/pets within a dynamic.", detailedDescription: "Consensual role-play [13] where one or more participants take on the persona, behaviors, and mindset of an animal or pet (commonly kittens, puppies, ponies, etc.), often within a dynamic with an Owner/Handler/Trainer [4/58]. Explores themes of dependence [P], instinct [40], non-verbal communication [I], training/obedience [11], or playful regression [39].", relatedIds: [13, 39, 4, 5, 10, 121, 40, 11], rarity: 'uncommon', keywords: ['Pet Play', 'Role-Play', 'Cognitive', 'Psychological', 'Animalistic', 'Dynamic', 'Kitten', 'Puppy', 'Regression', 'Obedience', 'Training'],
    lore: [
...
{
    id: 99, name: "Masochism (Psychological)", cardType: "Psychological/Goal", visualHandle: "uncommon_maso_psych.jpg", primaryElement: "P", elementScores: { A: 5, I: 3, S: 4, P: 8, C: 6, R: 5 }, briefDescription: "Finding pleasure or release in consensual mental/emotional 'pain'.", detailedDescription: "Deriving erotic pleasure, catharsis, or psychological [P] release from consensually experiencing emotional distress, humiliation [45], degradation, embarrassment, fear [106], or mental anguish within a safe, controlled interaction [I]. The 'pain' is mental/emotional, not necessarily physical.", relatedIds: [5, 17, 45, 100, 120, 11, 38], rarity: 'uncommon', keywords: ['Masochism', 'Psychological', 'Emotion', 'Submission', 'Distress', 'Catharsis', 'Humiliation', 'Mental Pain', 'Endurance', 'Release'],
    lore: [
...
{
    id: 100, name: "Sadism (Psychological)", cardType: "Psychological/Goal", visualHandle: "uncommon_sad_psych.jpg", primaryElement: "P", elementScores: { A: 5, I: 7, S: 4, P: 8, C: 7, R: 5 }, briefDescription: "Pleasure from consensually causing mental/emotional 'pain'.", detailedDescription: "Finding erotic pleasure, satisfaction, or a sense of power [P] from consensually and ethically causing emotional distress, humiliation [45], degradation, fear [106], or mental discomfort in a willing partner. The focus is on the partner's psychological reaction and the sadist's role in eliciting it.", relatedIds: [4, 11, 45, 99, 120, 32], rarity: 'uncommon', keywords: ['Sadism', 'Psychological', 'Emotion', 'Control', 'Distress', 'Humiliation', 'Mental Pain', 'Power', 'Reaction'],
    lore: [
...
{
    id: 102, name: "Sensory Focus (Specific Zone)", cardType: "Practice/Kink", visualHandle: "uncommon_sens_zone.jpg", primaryElement: "S", elementScores: { A: 5, I: 6, S: 7, P: 5, C: 4, R: 5 }, briefDescription: "Zooming all sensory attention onto one body part.", detailedDescription: "Giving intense, focused, and prolonged attention to stimulating one specific body part or zone (e.g., feet [62], neck, ears, hands, genitals), often to the exclusion of others. This deliberate narrowing of focus [S] can heighten awareness, build intense localized pleasure or sensation, and increase anticipation [P].", relatedIds: [57, 2, 61, 62], rarity: 'uncommon', keywords: ['Sensation', 'Focus', 'Body Part', 'Intensity', 'Physical', 'Zone', 'Localized', 'Detail', 'Attention'],
    lore: [
...
{
    id: 103, name: "Androgyny Attraction", cardType: "Orientation", visualHandle: "uncommon_andro.jpg", primaryElement: "A", elementScores: { A: 7, I: 5, S: 5, P: 5, C: 5, R: 5 }, briefDescription: "Drawn to gender-blending or ambiguous presentations.", detailedDescription: "Finding individuals whose gender presentation intentionally mixes elements typically associated with different genders, blurs traditional masculine/feminine markers, or presents ambiguously inherently attractive [A]. It's an appreciation for aesthetics that challenge or transcend binary gender norms.", relatedIds: [55, 92], rarity: 'uncommon', keywords: ['Attraction', 'Androgyny', 'Gender Presentation', 'Aesthetic', 'Non-binary', 'Genderfluid', 'Ambiguity', 'Fluidity'],
    lore: [
...
{
    id: 105, name: "Voyeuristic Exhibitionism", cardType: "Identity/Role", visualHandle: "uncommon_voy_exhib.jpg", primaryElement: "I", elementScores: { A: 7, I: 7, S: 5, P: 7, C: 6, R: 6 }, briefDescription: "Loving both watching and being watched simultaneously.", detailedDescription: "Getting turned on by the dynamic interplay of *both* sides of the gaze – finding arousal in watching others [19] get intimate *while* also being watched [18] yourself, often in a group [34] or multi-partner setting. It's about the shared energy of mutual observation and performance.", relatedIds: [18, 19, 34], rarity: 'uncommon', keywords: ['Exhibitionism', 'Voyeurism', 'Visual', 'Performance', 'Shared', 'Group', 'Reciprocal', 'Gaze'],
    lore: [
...
{
    id: 106, name: "Fear Play (Mild)", cardType: "Practice/Kink", visualHandle: "uncommon_fear_mild.jpg", primaryElement: "P", elementScores: { A: 5, I: 6, S: 6, P: 7, C: 5, R: 5 }, briefDescription: "Getting thrills from safe scares and anticipation.", detailedDescription: "Consensually using elements of surprise, startle moments, psychological tension, or the anticipation of something intense (but ultimately safe) to generate excitement and adrenaline [P]. Think jump scares in a dark room, suspenseful build-up to sensation [S], or playing with predator/prey dynamics [40] without genuine threat.", relatedIds: [44, 38, 9, 111, 122, 117, 17], rarity: 'uncommon', keywords: ['Fear', 'Anticipation', 'Thrill', 'Psychological', 'Edge', 'Startle', 'Suspense', 'Adrenaline', 'Safe Scare'],
    lore: [
...
{
    id: 107, name: "Tribadism / Scissoring", cardType: "Practice/Kink", visualHandle: "uncommon_tribadism.jpg", primaryElement: "S", elementScores: { A: 5, I: 6, S: 7, P: 5, C: 2, R: 5 }, briefDescription: "Direct vulva-on-vulva friction for mutual pleasure.", detailedDescription: "A sexual act, common among women who have sex with women but possible for anyone with vulvas, involving rubbing vulvas together (or against another body part like thigh or stomach) to create friction and mutual clitoral/vulval stimulation [S]. Positions can vary (e.g., 'scissoring').", relatedIds: [1, 67, 73], rarity: 'uncommon', keywords: ['Tribadism', 'Scissoring', 'Physical', 'Sensation', 'Friction', 'Lesbian', 'Sapphic', 'Vulva', 'Mutual'],
    lore: [
...
{
    id: 108, name: "Intercrural Sex (Frotting)", cardType: "Practice/Kink", visualHandle: "uncommon_frotting.jpg", primaryElement: "S", elementScores: { A: 5, I: 6, S: 7, P: 5, C: 2, R: 5 }, briefDescription: "Penis-on-penis (or thigh) friction for pleasure.", detailedDescription: "A sexual act, common among men who have sex with men but possible for others, involving rubbing penises together ('frotting') or against a partner's thighs ('intercrural') to create friction and mutual stimulation [S]. It's a non-penetrative form of achieving pleasure.", relatedIds: [1, 73], rarity: 'uncommon', keywords: ['Frotting', 'Intercrural', 'Physical', 'Sensation', 'Friction', 'Gay', 'MSM', 'Mutual', 'Non-Penetrative'],
    lore: [
...
{
    id: 110, name: "Figging", cardType: "Practice/Kink", visualHandle: "uncommon_figging.jpg", primaryElement: "S", elementScores: { A: 3, I: 6, S: 8, P: 6, C: 3, R: 5 }, briefDescription: "Using ginger root for an intense internal sting!", detailedDescription: "An old-school BDSM practice involving inserting a piece of peeled ginger root into the anus or vagina. The gingerol compounds react with body heat and moisture, creating an intense, inescapable internal stinging or burning sensation [S] that builds over time. Requires caution and understanding.", relatedIds: [9, 8], rarity: 'uncommon', keywords: ['Figging', 'Sensation', 'Intensity', 'Pain Play', 'BDSM', 'Sting', 'Internal', 'Chemical', 'Historical'],
    lore: [
    ...
    // --- Rare Concepts (Applying similar enhancements - Select examples shown) ---
    {
        id: 8, name: "Impact Play (Heavy)", cardType: "Practice/Kink", visualHandle: "rare_impact_heavy.jpg", primaryElement: "S", elementScores: { A: 5, I: 7, S: 9, P: 7, C: 4, R: 6 }, briefDescription: "Intense impact, feeling the resonant oomph.", detailedDescription: "Significantly turning up the volume and intensity of impact! Using heavier tools like canes, whips, heavy paddles, floggers, or even fists to deliver strong, often painful but desired sensations [S]. Can be about testing limits [P], the psychological dynamic of enduring/inflicting [I], the visual/physical evidence of marks, achieving altered states [P], or the unique quality of deep, resonant impact. Trust [15] and safety protocols are absolutely paramount.", relatedIds: [7, 9, 4, 5, 44, 97, 110, 40], rarity: 'rare', canUnlockArt: true, visualHandleUnlocked: "rare_impact_heavy_art", uniquePromptId: "rP08", keywords: ['Impact', 'Pain Play', 'Intensity', 'Sensation', 'Endurance', 'Marking', 'Control', 'BDSM', 'Heavy', 'Limits', 'Trust', 'Safety'],
        lore: [
    ...
    {
        id: 11, name: "Command / Control Dynamics", cardType: "Psychological/Goal", visualHandle: "rare_control.jpg", primaryElement: "I", elementScores: { A: 6, I: 9, S: 5, P: 8, C: 8, R: 6 }, briefDescription: "Explicit power exchange through giving/following clear orders.", detailedDescription: "This interaction style [I] is built around clear, explicit instructions and the corresponding act of willing obedience. One partner (Dominant [4]) gives direct commands, sets specific tasks, or issues instructions, and the other partner (submissive [5]) derives pleasure, purpose, or fulfillment [P] from understanding and obeying them precisely. Power exchange made tangible through action and response.", relatedIds: [4, 5, 10, 30, 38, 45, 41, 89, 90, 100, 101, 109, 119, 120, 98], rarity: 'rare', canUnlockArt: true, visualHandleUnlocked: "rare_control_art", uniquePromptId: "rP11", keywords: ['Control', 'Command', 'Obedience', 'Power', 'Structure', 'Psychological', 'Interaction', 'D/s', 'Instructions', 'Direction', 'Compliance'],
        lore: [
    ...
    {
        id: 12, name: "Objectification Play", cardType: "Psychological/Goal", visualHandle: "rare_object.jpg", primaryElement: "P", elementScores: { A: 7, I: 4, S: 6, P: 8, C: 6, R: 5 }, briefDescription: "Playing with being (or using) a 'thing' for pleasure.", detailedDescription: "A consensual psychological [P] game where one person is intentionally treated, or treats another, more like an object valued primarily for its function, use, or specific body parts, rather than as a whole person with complex emotions in that moment. Can explore themes of power [I], intense focus [S], dehumanization (safely!), service [10], or worship [61], depending on the negotiation.", relatedIds: [4, 5, 20, 18, 19, 45, 61, 42, 62, 114, 94, 21], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP12", keywords: ['Objectification', 'Power', 'Psychological', 'Focus', 'Body', 'Dehumanization', 'Play', 'Use', 'Tool', 'Consent', 'Function'],
        lore: [
    ...
    {
        id: 14, name: "Fantasy Immersion", cardType: "Cognitive", visualHandle: "rare_fantasy.jpg", primaryElement: "C", elementScores: { A: 5, I: 3, S: 4, P: 7, C: 9, R: 3 }, briefDescription: "Living fully within the mind's detailed story.", detailedDescription: "Your imagination isn't just involved; it *is* the main stage! Getting completely lost in complex, internally generated fantasy worlds, detailed narratives, or the powerful *idea* or symbolism of what's happening is far more crucial and arousing than the immediate physical reality. Arousal lives, breathes, and climaxes primarily within the intricate architecture of the brain [C].", relatedIds: [13, 29, 41, 42, 49, 60], rarity: 'rare', canUnlockArt: true, visualHandleUnlocked: "rare_fantasy_art", uniquePromptId: "rP14", keywords: ['Fantasy', 'Cognitive', 'Immersion', 'Narrative', 'Mind', 'World-Building', 'Imagination', 'Internal', 'Story', 'Arousal Source'],
        lore: [
    ...
    {
        id: 17, name: "Restriction / Helplessness", cardType: "Psychological/Goal", visualHandle: "rare_restrict.jpg", primaryElement: "P", elementScores: { A: 5, I: 3, S: 7, P: 9, C: 5, R: 5 }, briefDescription: "Finding deep pleasure in being bound/powerless.", detailedDescription: "The *psychological feeling* [P] of being physically restrained (whether by ropes [16], cuffs [87], posture, or other means) and the resulting mental space of surrendered control, helplessness, or profound vulnerability is itself a primary source of arousal or peace. It's often less about the specific method of restraint and more about the potent *internal state* it induces.", relatedIds: [16, 5, 9, 37, 44, 63, 64, 87, 99, 113, 117, 118, 125, 43], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP17", keywords: ['Helplessness', 'Surrender', 'Restriction', 'Psychological', 'Power', 'Vulnerability', 'Bondage', 'Immobility', 'Letting Go', 'Trust'],
        lore: [
    ...
    {
        id: 20, name: "Latex / Material Fetish", cardType: "Orientation", visualHandle: "rare_latex.jpg", primaryElement: "A", elementScores: { A: 9, I: 5, S: 8, P: 6, C: 5, R: 4 }, briefDescription: "Shiny, squeaky, second-skin sexy!", detailedDescription: "It's all about the specific material! A strong, often primary sexual attraction [A] triggered powerfully by the sight, feel, sound, or even smell of particular materials like latex, rubber, PVC, leather [94], silk, fur, spandex, etc. The material itself, enveloping the body or existing as an object, holds the magical charge and is often essential for arousal.", relatedIds: [12, 21, 42, 94, 112], rarity: 'rare', canUnlockArt: true, visualHandleUnlocked: "rare_latex_art", uniquePromptId: "rP20", keywords: ['Fetish', 'Material', 'Latex', 'Leather', 'PVC', 'Rubber', 'Attraction', 'Sensation', 'Focus', 'Texture', 'Smell', 'Sound', 'Visual'],
        lore: [
    ...
    {
        id: 21, name: "Uniform / Clothing Fetish", cardType: "Orientation", visualHandle: "rare_uniform.jpg", primaryElement: "A", elementScores: { A: 8, I: 6, S: 4, P: 6, C: 6, R: 5 }, briefDescription: "Specific clothing styles as primary arousal trigger.", detailedDescription: "A fetish where sexual arousal [A] is significantly and primarily triggered by specific types of clothing or outfits, such as uniforms (military, medical [43], school, service industry), specific costumes (superhero, historical), or particular garments (formal lingerie, sharp suits, specific dresses). The clothing itself carries powerful symbolic weight [C].", relatedIds: [13, 20, 12, 94, 95, 104, 43], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP21", keywords: ['Fetish', 'Clothing', 'Uniform', 'Attraction', 'Role-Play', 'Visual', 'Costume', 'Symbolism', 'Authority', 'Power', 'Archetype'],
        lore: [
    ...
    },
    {
     ...
     {
        id: 30, name: "High Protocol D/s", cardType: "Practice/Kink", visualHandle: "rare_protocol.jpg", primaryElement: "I", elementScores: { A: 6, I: 8, S: 6, P: 8, C: 9, R: 7 }, briefDescription: "Highly structured, formal power exchange.", detailedDescription: "A style of Dominance and submission [4/5] characterized by significant, often intricate structure, formal pre-negotiated rules, specific rituals (greetings, specific behaviors), defined forms of address (titles like Sir/Ma'am/Master/slave), and clear expectations for behavior within the dynamic [I]. Often involves a high degree of Cognitive [C] engagement in learning and executing the protocol.", relatedIds: [4, 5, 11, 13, 38, 101, 109], rarity: 'rare', canUnlockArt: true, visualHandleUnlocked: "rare_protocol_art", uniquePromptId: "rP30", keywords: ['Protocol', 'Structure', 'Rules', 'Power', 'Cognitive', 'Ritual', 'D/s', 'Formal', 'Hierarchy', 'Discipline', 'Etiquette'],
        lore: [
     ...
     {
        id: 42, name: "Transformation Fetish (TF)", cardType: "Orientation", visualHandle: "rare_transform.jpg", primaryElement: "C", elementScores: { A: 7, I: 4, S: 5, P: 7, C: 8, R: 4 }, briefDescription: "Arousal strongly linked to transformation themes.", detailedDescription: "A fetish or paraphilia centered on the concept and fantasy [C] of transformation itself. This can encompass a wide range: physical changes (e.g., into animals - zoomorphy, inanimate objects [12], different genders - gender TF), mental/personality changes (e.g., bimbofication, intelligence shifts, personality alteration), or forced/magical changes within a specific power dynamic [I]. The *process* or *idea* of changing state is key.", relatedIds: [20, 21, 12, 41, 14, 121, 92], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP42", keywords: ['Transformation', 'Fetish', 'Cognitive', 'Fantasy', 'Change', 'Identity', 'TF', 'Metamorphosis', 'Physical Change', 'Mental Change', 'Shapeshifting'],
        lore: [
     ...
     {
        id: 43, name: "Medical Play", cardType: "Practice/Kink", visualHandle: "rare_medical.jpg", primaryElement: "C", elementScores: { A: 5, I: 6, S: 7, P: 7, C: 7, R: 6 }, briefDescription: "Role-playing medical/clinical scenarios for arousal.", detailedDescription: "Consensual role-playing [13] involving medical themes, settings (clinic, hospital), specific roles (doctor, nurse, patient), or equipment. Can range from simple doctor/patient check-up scenarios to more clinical or invasive interactions involving mock (or sometimes real/blunt, with extreme caution) examinations, implements (speculums, thermometers, enemas, needles [9]), restraints [17], and exploration of the inherent power dynamics [I] and vulnerability [P] present in medical settings.", relatedIds: [13, 9, 17, 4, 5, 21], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP43", keywords: ['Medical Play', 'Role-Play', 'Scenario', 'Power', 'Clinical', 'Sensation', 'Exam', 'Doctor', 'Nurse', 'Patient', 'Vulnerability', 'Authority'],
        lore: [
     ...
     {
        id: 45, name: "Humiliation / Degradation", cardType: "Psychological/Goal", visualHandle: "rare_humiliation.jpg", primaryElement: "P", elementScores: { A: 5, I: 7, S: 4, P: 9, C: 6, R: 6 }, briefDescription: "Finding pleasure in consensual embarrassment/degradation.", detailedDescription: "Consensual play where one partner derives erotic pleasure or psychological [P] release from performing or receiving acts or words intentionally designed to cause embarrassment, shame, belittlement, or degradation within a safe, negotiated context. Can range from light teasing and name-calling to intense, elaborate psychological scenarios. Consent, trust [15], and thorough aftercare [69] are absolutely critical.", relatedIds: [4, 5, 10, 11, 12, 38, 41, 99, 100, 114, 115, 120], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP45", keywords: ['Humiliation', 'Degradation', 'Psychological', 'Power', 'Emotion', 'Shame', 'Taboo', 'Consent', 'Erotic Humiliation', 'Verbal', 'Scenario'],
        lore: [
    ...
    {
        id: 64, name: "CNC (Consensual Non-Consent)", cardType: "Practice/Kink", visualHandle: "rare_cnc.jpg", primaryElement: "C", elementScores: { A: 6, I: 7, S: 7, P: 8, C: 9, R: 6 }, briefDescription: "Safely role-playing scenarios involving lack of consent.", detailedDescription: "A complex form of consensual role-playing [13] where participants intentionally act out a scene involving simulated non-consent, coercion, force, or resistance (e.g., simulated rape fantasy, abduction [117], struggling against bonds [17]). Requires meticulous, enthusiastic prior negotiation [C], crystal-clear boundaries, unambiguous safewords that are instantly honored, and deep trust [15] to ensure the 'non-consent' stays strictly within the fictional frame.", relatedIds: [13, 4, 5, 17, 44, 117, 118, 38], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP64", keywords: ['CNC', 'Role-Play', 'Fantasy', 'Cognitive', 'Power', 'Taboo', 'Consent', 'Safety', 'Negotiation', 'Rape Fantasy', 'Simulated', 'Boundaries'],
        lore: [
     ...
     {
        id: 109, name: "Master / slave Dynamic (M/s)", cardType: "Relationship Style", visualHandle: "rare_ms.jpg", primaryElement: "I", elementScores: { A: 6, I: 9, S: 6, P: 9, C: 8, R: 7 }, briefDescription: "Profound, often total, power exchange relationship.", detailedDescription: "A specific, high-intensity, and deeply committed form of Dominance and submission [4/5] relationship characterized by a significant, often formalized, exchange of power and authority [I]. Often involves the concept of 'ownership' (consensually given), specific titles, high protocol [30], and frequently extends beyond the bedroom to encompass many aspects of daily life ('lifestyle' or TPE - Total Power Exchange). Requires immense trust [15] and communication [C].", relatedIds: [4, 5, 11, 30, 10], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP109", keywords: ['M/s', 'Power', 'Total Power Exchange', 'Commitment', 'Structure', 'D/s', 'Lifestyle', 'TPE', 'Ownership', 'Authority', 'Devotion', 'High Protocol'],
        lore: [
     ...
     {
        id: 111, name: "Knife Play / Edge Play (Sharp)", cardType: "Practice/Kink", visualHandle: "rare_knife.jpg", primaryElement: "S", elementScores: { A: 5, I: 7, S: 9, P: 8, C: 6, R: 6 }, briefDescription: "Using blades for intense sensation/fear (HIGH RISK!).", detailedDescription: "A form of edge play [44] involving the careful, consensual use of knives or other sharp objects against the skin. Can be purely for intense sensation [S] (the cold flat, the sharp edge tracing lines), psychological fear/thrill [P/106], symbolic marking (without cutting deeper than surface layers - cutting carries extreme risks!), or exploring power dynamics [I]. Requires intense focus, control, and absolute trust.", relatedIds: [44, 9, 106, 4, 116], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP111", keywords: ['Knife Play', 'Edge Play', 'Risk', 'Fear', 'Sensation', 'Control', 'Trust', 'Sharp', 'Safety', 'Blade', 'High-Risk', 'Psychological'],
        lore: [
     ...
     
{
     ...
     {
        id: 114, name: "Water Sports / Urolagnia", cardType: "Practice/Kink", visualHandle: "rare_watersports.jpg", primaryElement: "S", elementScores: { A: 6, I: 6, S: 7, P: 7, C: 4, R: 5 }, briefDescription: "Consensual play involving urine.", detailedDescription: "Sexual arousal or activity involving urine, also known as urolagnia or 'golden showers.' Can range from watching urination, to being urinated on ('showering'), to drinking urine (urophagia - higher risk). Often involves themes of taboo breaking [P], humiliation/degradation [45], marking/possession [I], or simple enjoyment of the warm sensation [S] and intimacy. Consent and discussion of hygiene/health risks are key.", relatedIds: [45, 12, 115], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP114", keywords: ['Watersports', 'Urolagnia', 'Taboo', 'Humiliation', 'Bodily Fluids', 'Piss Play', 'Golden Shower', 'Marking', 'Consent'],
        lore: [
     ...
     {
        id: 115, name: "Scat Play / Coprophilia", cardType: "Practice/Kink", visualHandle: "rare_scat.jpg", primaryElement: "S", elementScores: { A: 5, I: 5, S: 6, P: 8, C: 3, R: 4 }, briefDescription: "Consensual play involving feces (EXTREME!).", detailedDescription: "Sexual arousal or activity involving feces (poop), also known as coprophilia. This is generally considered an extreme fetish with significant health risks (bacteria, parasites) and strong social stigma. Play can range from observing defecation to direct contact or smearing. Requires extreme caution regarding hygiene, thorough discussion, enthusiastic consent, and awareness of risks.", relatedIds: [114, 45], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP115", keywords: ['Scat', 'Coprophilia', 'Taboo', 'Extreme', 'Risk', 'Bodily Fluids', 'Feces', 'Hygiene', 'Consent', 'Stigma'],
        lore: [
     ...
     {
        id: 118, name: "Somnophilia / Sleep Play", cardType: "Practice/Kink", visualHandle: "rare_somno.jpg", primaryElement: "C", elementScores: { A: 7, I: 3, S: 6, P: 7, C: 7, R: 4 }, briefDescription: "Arousal linked to observing or interacting with someone asleep (or feigning).", detailedDescription: "Sexual arousal or interest derived from interacting with or observing someone who is genuinely asleep or (more commonly in consensual play) *feigning* sleep. Often involves themes of vulnerability [P], taboo, voyeurism [19], and the perceived helplessness [17] or unawareness of the 'sleeping' partner. Enthusiastic consent negotiated *while awake* is absolutely paramount for any ethical exploration.", relatedIds: [19, 17, 64], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP118", keywords: ['Somnophilia', 'Sleep Play', 'Vulnerability', 'Voyeurism', 'Consent', 'Fantasy', 'Unaware', 'Taboo', 'Pretend', 'Observation'],
        lore: [
     ...
     {
        id: 119, name: "Forced Orgasm / Orgasm Control", cardType: "Practice/Kink", visualHandle: "rare_forceorgasm.jpg", primaryElement: "I", elementScores: { A: 5, I: 8, S: 8, P: 8, C: 7, R: 6 }, briefDescription: "Dominant partner controlling the timing/occurrence of orgasm.", detailedDescription: "A power dynamic [I] where one partner (Dominant [4]) intentionally controls if, when, how, and sometimes how intensely the other partner (submissive [5]) experiences orgasm. This can involve prolonging stimulation to the edge [38], denying orgasm completely (denial), demanding orgasm on command, or pushing the submissive to orgasm repeatedly, potentially past their usual limits. Explores themes of control [P], endurance [S], and pleasure/frustration.", relatedIds: [38, 11, 4, 5, 112, 9], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP119", keywords: ['Orgasm Control', 'Forced Orgasm', 'Power', 'Control', 'Denial', 'Pleasure', 'Intensity', 'BDSM', 'Command', 'Endurance', 'Edge'],
        lore: [
     ...
     {
        id: 120, name: "Psychological Torture Play", cardType: "Practice/Kink", visualHandle: "rare_psychtorture.jpg", primaryElement: "P", elementScores: { A: 4, I: 7, S: 4, P: 9, C: 8, R: 6 }, briefDescription: "Consensual intense mind games & emotional manipulation.", detailedDescription: "Consensual, ethically navigated play involving intense psychological manipulation, intricate mind games, gaslighting (strictly within pre-agreed limits and themes), emotional challenges, or mental endurance tests designed to push cognitive [C] and emotional [P] boundaries. Requires extreme trust [15], meticulous negotiation, clear safewords, and robust aftercare [69].", relatedIds: [45, 41, 100, 99, 11, 44], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP120", keywords: ['Psychological Torture', 'Mind Games', 'Manipulation', 'Emotion', 'Power', 'Edge Play', 'Trust', 'Consent', 'Gaslighting (Consensual)', 'Mental Endurance', 'High Risk'],
        lore: [
     ...
     {
        id: 121, name: "Furry Fandom Sexuality", cardType: "Identity/Role", visualHandle: "rare_furrysex.jpg", primaryElement: "C", elementScores: { A: 6, I: 6, S: 5, P: 6, C: 7, R: 6 }, briefDescription: "Expressing sexuality through anthropomorphic personas/community.", detailedDescription: "Expressing sexuality through or within the specific context of the furry fandom. This often involves anthropomorphic animal characters (fursonas) representing aspects of identity, potentially incorporating fursuits or other costume elements, engaging in role-play [13] based on these personas, creating/consuming furry-themed erotic art ('yiff'), and adhering to specific community norms and etiquette [R].", relatedIds: [13, 98, 42], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP121", keywords: ['Furry', 'Fandom', 'Identity', 'Role-Play', 'Community', 'Anthropomorphic', 'Fursona', 'Yiff', 'Costume', 'Persona', 'Subculture'],
        lore: [
     ...
     {
        id: 122, name: "Autassassinophilia", cardType: "Orientation", visualHandle: "rare_autassass.jpg", primaryElement: "P", elementScores: { A: 5, I: 2, S: 7, P: 8, C: 6, R: 3 }, briefDescription: "Arousal derived from *staged* risk of being killed.", detailedDescription: "A specific paraphilia involving deriving sexual arousal from the fantasy [C] or *staged* scenario of being hunted, stalked, attacked, or otherwise put at risk of being killed – all within a carefully controlled, safe, and consensual context. It's about the intense psychological [P] thrill and adrenaline generated by simulating mortal danger, not actual harm.", relatedIds: [44, 106, 117], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP122", keywords: ['Autassassinophilia', 'Risk', 'Fear', 'Edge Play', 'Fantasy', 'Thrill', 'Paraphilia', 'Staged Danger', 'Mortality', 'Adrenaline', 'Hunt'],
        lore: [
     ...
     {
        id: 123, name: "Exposure Therapy Play", cardType: "Psychological/Goal", visualHandle: "rare_exposure.jpg", primaryElement: "P", elementScores: { A: 4, I: 6, S: 5, P: 8, C: 7, R: 7 }, briefDescription: "Using BDSM scenes to process fears/trauma (Requires Care!).", detailedDescription: "Carefully and meticulously negotiated BDSM or role-play scenes intentionally designed to gently revisit, re-contextualize, or process past trauma, triggers, or deep-seated fears in a safe, supportive, and empowering setting [P/R]. Requires immense trust [15], clear communication [C], potentially professional guidance (therapist collaboration), and an unwavering focus on healing and integration, *not* re-traumatization.", relatedIds: [15, 69, 4, 5, 58], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP123", keywords: ['Exposure Therapy', 'Trauma', 'Healing', 'Psychological', 'Trust', 'Safety', 'BDSM', 'Therapeutic', 'Processing', 'Integration', 'Empowerment', 'Care'],
        lore: [
     ...
     {
        id: 125, name: "Breath Control (Advanced)", cardType: "Practice/Kink", visualHandle: "rare_breath_adv.jpg", primaryElement: "S", elementScores: { A: 4, I: 7, S: 9, P: 8, C: 4, R: 6 }, briefDescription: "Precise breathing manipulation techniques (EXTREME RISK!).", detailedDescription: "Advanced, highly technical forms of breath play [63] involving more precise control over inhalation/exhalation cycles, potentially using tools like rebreather bags or masks under extremely controlled, knowledgeable, and vigilant conditions. May involve coaching specific breathing patterns to induce altered states. **Carries extreme and potentially lethal risks.** Requires expert knowledge and safety protocols.", relatedIds: [63, 44, 17], rarity: 'rare', canUnlockArt: false, uniquePromptId: "rP125", keywords: ['Breath Play', 'Asphyxiation', 'Risk', 'Edge Play', 'Control', 'Intensity', 'Skill', 'Safety', 'Hypoxia', 'Hypercapnia', 'Advanced', 'High-Risk'],
        lore: [
     ...
     } // NO comma needed after the last item in the `concepts` array
]; // END OF CONCEPTS ARRAY

// --- Utility Maps & Arrays --- (No changes needed here, kept for completeness)
...
// --- Questionnaire Data --- (Enhanced labels/text)
...
// --- Reflection Prompts --- (Enhanced depth and engagement)
const reflectionPrompts = {
    ...
    "Dissonance": [ // Prompts for when a concept feels 'off'
    ...
    "Guided": { // Prompts triggered by game state
        "LowAttunement": [
            { id: "gLA1", text: "Just beginning your alchemical journey into self-knowledge! Of the six core Elements (Attraction, Interaction, etc.), which one feels most mysterious, intriguing, or perhaps even slightly intimidating right now? Let's gently ponder that first step." },
    ...
    "RareConcept": { // Specific prompts for rare concepts
    ...
    "SceneMeditation": { // Prompts for meditating on scene blueprints
...
// --- Element Deep Dive Content (Enhanced titles and content) ---
const elementDeepDive = {
    "A": [
        {
            level: 1,
            title: "Level 1: Deciphering the Spark - Your Attraction Compass",
            insightCost: 10,
            content: "<p>Attraction: the mysterious force that first draws us in, the needle on our 'Desire Compass.' Often, it points towards familiar territory: physical appearance, specific gender presentations, or a captivating energy. But sometimes, the compass spins wildly, or lies dormant (as explored within the diverse Asexuality spectrum). Begin by observing: What patterns do you notice in your *initial* magnetic pull towards others, situations, or even abstract concepts? Is your compass generally consistent, or does its true north shift with time, mood, or context?</p>"
        },
        {
            level: 2,
            title: "Level 2: Beyond First Sight - Deeper Magnetic Fields",
            insightCost: 25,
            content: "<p>Let's dig beneath the surface magnetism. Is it the lightning strike of a sharp mind (Sapiosexuality) that truly captivates you? Or perhaps a specific, compelling dynamic of power – the allure of confident authority [81] or the pull of tender vulnerability? Remember, sometimes attraction isn't about a *person* at all, but a specific object, texture, material, or situation (a fetish [20, 21, 62, 94]) that acts as a potent catalyst. How does needing a deep emotional connection *first* (Demisexuality [29]) change the fundamental nature of the spark and how it ignites?</p>"
        },
        {
            level: 3,
            title: "Level 3: From Spark to Flame - Cultivating Desire's Fire",
            insightCost: 50,
            content: "<p>Attraction is the potential, but arousal is the fire. What bridges that gap for you? Is your desire often ready and waiting, like dry tinder (spontaneous desire)? Or does it need careful coaxing and the right conditions to catch light (responsive desire)? Consider the influence of context: does a safe, trusting environment [P] make the flame burn brighter and hotter? Does stress, disconnect, or feeling unsafe dampen it significantly? How fixed is your compass – could its definition of 'true north' evolve over time, through experience, or with different, trusted partners [R]?</p>"
        }
    ],
    "I": [
        {
            level: 1,
            title: "Level 1: The Dance of Connection - Leading, Following, Flowing",
            insightCost: 10,
            content: "<p>Interaction is the energetic exchange, the intimate choreography. Do you naturally step forward, feeling comfortable setting the pace and leading the dance (Dominant/Top leaning [4])? Or do you find profound joy and freedom in following your partner's rhythm, surrendering to their lead (Submissive/Bottom leaning [5])? Perhaps you're a master of improvisation, flowing effortlessly between roles, co-creating the movement moment by moment (Switch [6])? Reflect on your most satisfying interactions: what was the balance of giving and receiving energy? What felt most authentic?</p>"
        },
        {
            level: 2,
            title: "Level 2: Styles of Engagement - Finding Your Signature Move",
            insightCost: 25,
            content: "<p>Beyond simply leading or following, what's the distinct *flavor* or style of your interaction? Is it characterized by meticulous control and command [11]? Or perhaps profound devotion and service [10]? Maybe it's raw, unpredictable, and wonderfully instinctive (Primal Play [40]), or deeply tender and nurturing (Caregiver [58])? Do you come alive under the spotlight (Exhibitionism [18]) or prefer the intimate power of observing from the shadows (Voyeurism [19])? Where does your unique interaction style find its most fulfilling and resonant expression?</p>"
        },
        {
            level: 3,
            title: "Level 3: The Language of Play - Communication & Safety in Motion",
            insightCost: 50,
            content: "<p>How do you communicate desires, boundaries, and shifts within the dynamic dance? Is it primarily through clear verbal negotiation, explicit commands, and direct feedback? Or more through subtle energetic cues, intuitive responses, and shared understanding built over time? How crucial are safety tools like safewords and gestures? Consider the vital importance of 'aftercare' [69] – the gentle reconnection and grounding process after intensity fades. How do you ensure all participants feel safe, respected, and valued throughout the entire interaction, from beginning to end?</p>"
        }
    ],
    "S": [
        {
            level: 1,
            title: "Level 1: The Body's Alphabet - Basic Sensory Grammar",
            insightCost: 10,
            content: "<p>Your skin, your largest sensory organ, speaks a complex language. What dialects does it prefer? Gentle whispers and teasing hints (light caresses [2], warm breath)? Firm, grounding pronouncements (deep pressure, strong massage)? Does temperature play a significant role (the contrast of cool sheets vs. warm skin, the focused heat of breath)? What textures feel like poetry against your skin (smooth silk, rough cotton, soft fur)? Consider the simple, fundamental sensations that bring you immediate comfort, grounding, or initial sparks of physical pleasure.</p>"
        },
        {
            level: 2,
            title: "Level 2: Amplifying Sensation - Intensity & Edge",
            insightCost: 25,
            content: "<p>Sometimes, a whisper isn't enough; the body craves clearer, more intense signals. Where does heightened intensity enter your sensory world? Does the sharp, focused attention of a pinch or bite, the rhythmic punctuation of impact (light [7] or heavy [8]), or the fascinating sting of hot wax [9] hold potent appeal? What about the unique feeling of being physically bound [16, 87], the world temporarily reduced to the pressure of rope or cuffs, amplifying internal sensations? How does your body negotiate that fascinating, often thrilling edge where pleasure meets pain, or where sensation becomes overwhelming [86]?</p>"
        },
        {
            level: 3,
            title: "Level 3: A Symphony for the Senses - Beyond Touch",
            insightCost: 50,
            content: "<p>Intimacy is rarely just about touch. How do your other senses weave into the rich tapestry of your experience? Does a particular scent (perfume, pheromones, leather) transport you or trigger immediate arousal [A]? Can specific sounds (music, a partner's voice, sharp gasps, whispered words [32]) heighten everything dramatically? What role does the visual play – the aesthetics of the scene, the play of light and shadow, the sight of your partner's body or reaction? Explore how intentionally engaging (or deliberately depriving [37]) multiple senses can create complex, sometimes overwhelming, and deeply personal states of arousal, focus, or altered consciousness.</p>"
        }
    ],
    "P": [
        {
            level: 1,
            title: "Level 1: The Heart's Compass - Charting Your 'Why'",
            insightCost: 10,
            content: "<p>Intimacy is rarely just skin-deep, a purely physical act. What deeper currents, what fundamental psychological needs or desires, pull you towards connection? Peer into your inner world: Is it the profound merging of souls found in <strong>shared vulnerability</strong> and deep trust you seek [15]? The electric thrill of wielding consensual <strong>power</strong> [4], or the liberating release found in profound <strong>surrender</strong> [5]? Perhaps it's the fundamental human need to feel utterly <strong>desired and validated</strong> [50], or maybe intimacy serves as a sacred space to <strong>escape</strong> the world's clamor and find temporary peace [51]? Identify the core psychological 'quests' that intimacy helps you navigate.</p>"
        },
        {
            level: 2,
            title: "Level 2: Mapping Emotional Landscapes & Inner States",
            insightCost: 25,
            content: "<p>Vulnerability, that double-edged sword demanding courage, is often the key to unlocking deeper trust and authentic connection. How comfortable are you with letting your true, unmasked self be witnessed in intimate moments? Can intense emotional or physical experiences bring a purifying sense of <strong>catharsis</strong> or release? Have you touched those profound altered states – 'subspace,' 'flow,' 'rapture' – where the everyday thinking mind recedes, leaving pure presence? What specific conditions, words, or actions create the essential psychological <strong>safety net</strong> required for you to explore these potent inner landscapes without fear?</p>"
        },
        {
            level: 3,
            title: "Level 3: Inner Alchemy & Potential for Healing",
            insightCost: 50,
            content: "<p>Our intimate lives often act as a mirror, reflecting our inner world – not just our joys and desires, but also our hidden fears, unresolved patterns, or 'shadow' aspects we might prefer not to see. Can consciously engaging in specific dynamics, roles, or fantasies within a trusting container become a crucible for understanding, integrating, or even healing [123] these parts? Or do you sometimes find yourself unconsciously repeating old relational stories? Consider the profound potential for intentional, consensual play to be a powerful tool for <strong>self-discovery, integration, and growth</strong> (used wisely, sometimes best navigated with additional support like therapy or trusted community guides).</p>"
        }
    ],
    "C": [
        {
            level: 1,
            title: "Level 1: The Theater of the Mind - Imagination's Stage",
            insightCost: 10,
            content: "<p>How active, vivid, and central is your inner world during intimate experiences? Are elaborate fantasies [14] playing out like immersive films behind your eyes? Are you actively analyzing the dynamic, tracking subtle cues? Or are you fully absorbed in the present moment's physical sensations [S] and emotional flow [P]? Explore the sheer power of imagination: how can simply *thinking* about something, hearing it described [32, 49], or anticipating it [83] spark potent arousal? What are the recurring themes, characters, or images that populate your mental theater when desire stirs?</p>"
        },
        {
            level: 2,
            title: "Level 2: Scripts, Scenarios, and Role-Play Realms",
            insightCost: 25,
            content: "<p>Do you relish the opportunity to step into a different role [13], embodying a character or archetype? What kind of scenarios hold the most appeal – forbidden encounters, historical settings, specific power dynamics [4, 5], fantastical creatures [121], professional roles [43]? How much detail and structure do you prefer in these cognitive plays? Is the 'story' itself, the narrative arc and its meaning, sometimes more important or arousing than the purely physical act? Reflect on the difference between a loosely guided improv scene versus a meticulously planned, high-protocol encounter [30].</p>"
        },
        {
            level: 3,
            title: "Level 3: The Intellectual Spark & Conceptual Fire",
            insightCost: 50,
            content: "<p>For some, the mind isn't just involved; it's the primary erogenous zone. Does witty banter, intellectual sparring, or demonstrating cleverness [60] significantly turn you on? Do you derive deep satisfaction from understanding the complex psychological motivations [P] within a dynamic, or analyzing the interaction [I] itself? Can symbolic actions, complex rule sets [30], or ritualistic elements elevate an experience beyond the physical into the realm of profound meaning? Explore how thought, abstraction, intricate planning, and mental games fuel your unique fire.</p>"
        }
    ],
    "R": [
        {
            level: 1,
            title: "Level 1: Mapping Your Connections - Constellation Basics",
            insightCost: 10,
            content: "<p>How do you prefer to structure your intimate world, your personal relationship 'constellation'? Does the deep focus and shared universe of a monogamous partnership [22] feel most fulfilling and natural? Or does the freedom and self-reliance of solo exploration [solitary focus] resonate more strongly? Perhaps the idea of navigating multiple meaningful connections simultaneously (Consensual Non-Monogamy [25, 26]) calls to you? Consider the basic blueprint: how many people, and what level of connection, feels 'right' in your intimate sphere at this time?</p>"
        },
        {
            level: 2,
            title: "Level 2: Defining the Bonds - Depth, Commitment, Fluidity",
            insightCost: 25,
            content: "<p>Beyond just the number, what *depth* and *type* of connection do you typically seek in intimacy? Is deep emotional intimacy [15] a prerequisite for physical connection, or perhaps the goal? Or are you comfortable and fulfilled with connections based primarily on fun, shared interests, physical chemistry, or temporary companionship (like Friends With Benefits [24] or casual encounters)? How does the concept of 'commitment' factor in? Can you experience and value different levels of commitment simultaneously with different people?</p>"
        },
        {
            level: 3,
            title: "Level 3: Navigating the Cosmos - Rules, Anarchy, & Emotion",
            insightCost: 50,
            content: "<p>If exploring multiple connections (Polyamory [25], Open Relationships [26], etc.) is your path, how do you navigate the complexities? Do you prefer clear rules, agreements, and potentially hierarchy (designating a 'primary' partner)? Or does the philosophy of letting each relationship define itself uniquely without comparison or imposed rules appeal more (Relationship Anarchy [27], non-hierarchical polyamory)? How do you skillfully and compassionately handle complex emotions like jealousy, envy, insecurity, or cultivate compersion (finding joy in a partner's other connections)? What communication and emotional intelligence skills are essential for navigating your chosen constellation ethically and joyfully?</p>"
        }
    ]
};

// --- Focus Rituals Data (Enhanced descriptions) ---
const focusRituals = [
...
// --- Repository Item Data (Enhanced names/descriptions) ---
...
const elementalInsights = [ // Making these more evocative/poetic and insightful
    ...
    { id: "EI_A05", element: "A", text: "The absence of attraction (Asexuality) is not an empty space, but a different landscape entirely, with its own unique beauty."}, // Added Ace-specific
    ...
    { id: "EI_I05", element: "I", text: "Switching roles is not indecision; it is mastery of the full spectrum of the dance."}, // Added Switch specific
    ...
    { id: "EI_S05", element: "S", text: "The line between pleasure and pain is not a wall, but a shimmering, personal, and often shifting veil."}, // Added pleasure/pain nuance
    ...
    { id: "EI_P05", element: "P", text: "Binding the body can paradoxically free the heart or mind, but only if unwavering trust holds the knot secure." }, // From FDU002
    ...
    { id: "EI_C05", element: "C", text: "Fantasy allows us to safely explore desires or identities the waking world might judge or forbid."}, // Added fantasy purpose
    ...
    { id: "EI_R05", element: "R", text: "Relationship Anarchy isn't chaos; it's the radical responsibility of defining every connection from scratch, based on mutual desire and respect."}, // Added RA specific
    { id: "IFC01", element: "C", text:"Weaving distinct thoughts yields unexpected threads... and sometimes reveals beautiful, intricate knots worth exploring."} // From EXP04 - enhanced
];

// --- Focus-Driven Unlocks Data (Enhanced descriptions) ---
...
// --- Category-Driven Unlocks Data (Enhanced descriptions) ---
const categoryDrivenUnlocks = [
    {
        id: "CDU001",
        requiredInSameCategory: [16, 17], // Rope Bondage & Restriction/Helplessness
        categoryRequired: "liked", // Must be in the "Liked" category/shelf
        unlocks: { type: "lore", targetConceptId: 16, loreLevelToUnlock: 3 }, // Unlock Level 3 lore for Rope Bondage
        description: "Deep Resonance! By categorizing both Rope Bondage [16] and Restriction/Helplessness [17] as 'Resonant Echoes' (Liked), you've unlocked deeper, level 3 lore for Rope Bondage!"
    },
    {
        id: "CDU002",
        requiredInSameCategory: [4, 11], // Dominance (Psych) & Command/Control
        categoryRequired: "coreIdentity", // Must be in the "Pillars of Self" category/shelf
        unlocks: { type: "insight", amount: 5 },
        description: "Pillar Affirmation! Acknowledging both Psychological Dominance [4] and Command/Control Dynamics [11] as 'Pillars of Self' (Core Identity) has granted you a bonus infusion of 5 Insight!"
    },
    {
        id: "CDU003",
        requiredInSameCategory: [8, 9], // Heavy Impact & Non-Impact Pain
        categoryRequired: "wantToTry", // Must be in "Curious Experiments"
        unlocks: { type: "attunement", element: "S", amount: 2 },
        description: "Intriguing Edge! Placing both Heavy Impact [8] and Non-Impact Pain [9] onto the 'Curious Experiments' shelf signals an interest in intense sensation, boosting your Sensory Attunement by 2!"
    },
    {
        id: "CDU004",
        requiredInSameCategory: [45, 114], // Humiliation & Watersports
        categoryRequired: "dislikedLimit", // Must be in "Boundaries Drawn"
        unlocks: { type: "insight", amount: 3 },
        description: "Boundary Wisdom! Clearly defining both Humiliation [45] and Watersports [114] as 'Boundaries Drawn' (Disliked/Limit) demonstrates self-awareness, granting 3 Insight."
    }
...
// --- Rituals & Milestones Data (Enhanced descriptions) ---
const dailyRituals = [
    { id: "dr01", description: "Daily Zen Scribbles: Perform Free Meditation Research (tap ☆ in Study).", reward: { type: "insight", amount: 2 }, track: { action: "freeResearch", count: 1, period: "daily" } },
    ...
    { id: "dr05", description: "Invest in Knowledge: Conduct Insight-fueled Research in the Study.", reward: { type: "attunement", element: "All", amount: 0.2 }, track: { action: "conductResearch", count: 1, period: "daily" } },
    { id: "dr06", description: "Deepen Understanding: Unlock an Element Insight Level in the Library.", reward: { type: "attunement", element: "All", amount: 0.5 }, track: { action: "unlockLibrary", count: 1, period: "daily"} },
    { id: "dr07", description: "Organize Your Thoughts: Move a Concept to a new Shelf in the Grimoire.", reward: { type: "insight", amount: 1 }, track: { action: "moveConceptShelf", count: 1, period: "daily"} } // Added Shelf ritual
];

const milestones = [
    // Collection Milestones
    { id: "ms01", description: "First Concept Claimed! Your Grimoire cracks open! Welcome, brave Alchemist!", reward: { type: "insight", amount: 5 }, track: { state: "discoveredConcepts.size", threshold: 1 } },
    { id: "ms02", description: "Budding Curator: 5 Concepts illuminate your Grimoire pages!", reward: { type: "insight", amount: 10 }, track: { state: "discoveredConcepts.size", threshold: 5 } },
    { id: "ms15", description: "Growing Archive: 15 Concepts catalogued! Your knowledge expands.", reward: { type: "insight", amount: 15 }, track: { state: "discoveredConcepts.size", threshold: 15 } },
    { id: "ms25", description: "Serious Collector: 25 Concepts secured! (Bonus: +1 Focus Slot! More threads for your tapestry!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { state: "discoveredConcepts.size", threshold: 25 } },
    { id: "ms40", description: "Impressive Compendium: 40 Concepts gathered! The patterns begin to emerge.", reward: { type: "insight", amount: 25 }, track: { state: "discoveredConcepts.size", threshold: 40 } },
    { id: "ms55", description: "Master Curator: 55 Concepts! Your Grimoire hums with potential! (Bonus: +1 Focus Slot!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { state: "discoveredConcepts.size", threshold: 55 } },
    { id: "ms75", description: "The Grand Archive: 75 Concepts collected! A testament to your dedication!", reward: { type: "insight", amount: 40 }, track: { state: "discoveredConcepts.size", threshold: 75 } },
    { id: "ms100", description: "Librarian of Desire: 100 Concepts Mapped! Your understanding is vast! (Bonus: +1 Focus Slot!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { state: "discoveredConcepts.size", threshold: 100 } }, // Added 100 milestone

    // Focus Milestones
    { id: "ms03", description: "First Focus Thread Chosen! Your personal Tapestry of Desire begins.", reward: { type: "insight", amount: 8 }, track: { state: "focusedConcepts.size", threshold: 1 } },
    { id: "ms04", description: "Tapestry Weaver: 3 Concepts actively Focused! Connections spark.", reward: { type: "attunement", element: "All", amount: 1 }, track: { state: "focusedConcepts.size", threshold: 3 } },
    { id: "ms08", description: "Expanding Focus: 5 Concepts Focused! New synergies possible! (Bonus: +1 Focus Slot!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { state: "focusedConcepts.size", threshold: 5 } },
    { id: "ms18", description: "Intricate Weaving: 7 Focus Slots actively engaged! Complexity deepens.", reward: { type: "insight", amount: 25 }, track: { state: "focusedConcepts.size", threshold: 7 } },
    { id: "ms35", description: "Complex Patterns Emerging: 9 Focus Slots filled! Your tapestry reveals intricate designs. (Bonus: +1 Focus Slot!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { state: "focusedConcepts.size", threshold: 9 } },
    { id: "ms48", description: "Tapestry Master: All 12 Focus Slots woven with intent! A map of your core.", reward: { type: "insight", amount: 50 }, track: { state: "focusedConcepts.size", threshold: 12 } },

    // Attunement & Research Milestones
    { id: "ms05", description: "Into the Alchemist's Study: First Insight-fueled Research Conducted!", reward: { type: "insight", amount: 5 }, track: { action: "conductResearch", count: 1 } },
    { id: "ms06", description: "Elemental Spark Ignited: Attunement 10+ reached in One Element!", reward: { type: "insight", amount: 15 }, track: { state: "elementAttunement", threshold: 10, condition: "any" } },
    { id: "ms13", description: "Balanced Flow Achieved: Attunement 5+ in ALL Six Elements!", reward: { type: "insight", amount: 20 }, track: { state: "elementAttunement", threshold: 5, condition: "all" } },
    { id: "ms20", description: "Elemental Adept: Attunement 50+ in One Element! True mastery begins. (Bonus: +1 Focus Slot!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { state: "elementAttunement", threshold: 50, condition: "any" } },
    { id: "ms30", description: "Elemental Master: Attunement 90+ in One Element! You command its energy!", reward: { type: "insight", amount: 40 }, track: { state: "elementAttunement", threshold: 90, condition: "any" } },
    { id: "ms45", description: "Harmonious Core Integration: Attunement 25+ in ALL Elements! Your inner landscape is balanced. (Bonus: +1 Focus Slot!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { state: "elementAttunement", threshold: 25, condition: "all" } },

    // Reflection Milestones
    { id: "ms07", description: "Gaze Within: First Reflection Completed! The journey inward starts.", reward: { type: "insight", amount: 5 }, track: { action: "completeReflection", count: 1 } },
    { id: "ms12", description: "Facing Shadows Bravely: Embraced a challenging Dissonant Reflection!", reward: { type: "attunement", element: "All", amount: 1.5 }, track: { action: "completeReflectionDissonance", count: 1 } },
    { id: "ms22", description: "Introspective Soul: Completed 5 Reflections. Deeper self-awareness blooms.", reward: { type: "insight", amount: 20 }, track: { action: "completeReflection", count: 5 } },
    { id: "ms23", description: "Open Mind, Shifting Scores: Allowed a Reflection's insight to gently Nudge Your Scores!", reward: { type: "insight", amount: 10 }, track: { action: "scoreNudgeApplied", count: 1 } },
    { id: "ms38", description: "Seasoned Reflector: Completed 10 Reflections! Wisdom deepens. (Bonus: +1 Focus Slot!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { action: "completeReflection", count: 10 } },
    { id: "ms52", description: "Dedicated Delver: Completed 20 Reflections! You know your inner landscape well.", reward: { type: "insight", amount: 30 }, track: { action: "completeReflection", count: 20 } }, // Added 20 reflections

    // Specific Unlocks & Discoveries
    { id: "ms09", description: "Master of the Dance: Interaction Attunement 20+! (Gift: Concept 'Switching' [6] discovered!)", reward: { type: "discoverCard", cardId: 6 }, track: { state: "elementAttunement", element: "I", threshold: 20 } },
    { id: "ms10", description: "Mind Palace Explorer: Cognitive Attunement 20+! (Gift: Concept 'Fantasy Immersion' [14] discovered!)", reward: { type: "discoverCard", cardId: 14 }, track: { state: "elementAttunement", element: "C", threshold: 20 } },
    { id: "ms11", description: "Awakened Art! A Concept's deeper visual essence revealed through evolution!", reward: { type: "insight", amount: 20 }, track: { action: "evolveArt", count: 1 } },
    { id: "ms21", description: "Rare Jewel Unearthed! You've discovered a potent, Rare Concept!", reward: { type: "insight", amount: 15 }, track: { action: "discoverRareCard", count: 1 } },
    // NOTE: Concept ID 88 was requested for ms33. Assuming it's Temperature Play. Adjust if ID is different.
    { id: "ms33", description: "Sensory Savant: Sensory Attunement 30+! (Gift: Concept 'Temperature Play' [88] discovered!)", reward: { type: "discoverCard", cardId: 88 }, track: { state: "elementAttunement", element: "S", threshold: 30 } },
    { id: "ms42", description: "Art Connoisseur: Evolved the hidden Art for 3 different Concepts!", reward: { type: "insight", amount: 30 }, track: { action: "evolveArt", count: 3 } },
    { id: "ms50", description: "Lab Notes Complete: Initial Elemental Assessment Questionnaire finished!", reward: { type: "insight", amount: 10 }, track: { action: "completeQuestionnaire", count: 1 } },
    { id: "ms60", description: "Page Turner: Unlocked your First Element Insight in the Library!", reward: { type: "insight", amount: 5 }, track: { action: "unlockLibrary", count: 1} },
    { id: "ms61", description: "Elemental Initiate: Reached Insight Level 2 understanding for One Element.", reward: { type: "insight", amount: 10 }, track: { state: "unlockedDeepDiveLevels", threshold: 2, condition: "any"} },
    { id: "ms62", description: "Elemental Scholar: Reached Insight Level 3 understanding for One Element!", reward: { type: "insight", amount: 15 }, track: { state: "unlockedDeepDiveLevels", threshold: 3, condition: "any"} },
    { id: "ms63", description: "Broad Foundations: Unlocked Level 1 Insight for ALL Six Elements! Holistic view begins. (Bonus: +1 Focus Slot!)", reward: { type: "increaseFocusSlots", amount: 1 }, track: { state: "unlockedDeepDiveLevels", threshold: 1, condition: "all"} },
    { id: "ms70", description: "Scene Scholar: Meditated on a Scene Blueprint in the Repository.", reward: { type: "insight", amount: 10 }, track: { action: "meditateScene", count: 1 } },
    { id: "ms71", description: "Bold Alchemist: Attempted your first Alchemical Experiment!", reward: { type: "insight", amount: 15 }, track: { action: "attemptExperiment", count: 1 } },
    { id: "ms72", description: "Fragment Finder: Collected 3 potent Elemental Insights!", reward: { type: "attunement", element: "All", amount: 1.0 }, track: { state: "repositoryInsightsCount", threshold: 3 } },
    { id: "ms73", description: "Repository Rummager: Found at least 1 of Each Item Type (Scene, Experiment, Insight)!", reward: { type: "insight", amount: 20 }, track: { state: "repositoryContents", condition: "allTypesPresent" } },
    { id: "ms80", description: "Savvy Seller: Sold Your First Concept Card from the Grimoire!", reward: { type: "insight", amount: 5 }, track: { action: "sellConcept", count: 1 } },
    { id: "ms90", description: "Lore Seeker: Unlocked the First Level of Lore for any Concept!", reward: { type: "insight", amount: 5 }, track: { action: "unlockLore", condition: "anyLevel", threshold: 1 } },
    { id: "ms91", description: "Deep Lore Diver: Unlocked Lore Level 3 for any Concept!", reward: { type: "insight", amount: 15 }, track: { action: "unlockLore", condition: "level3", threshold: 1 } }, // Added Lore Milestone
    { id: "ms95", description: "Shelf Sorter Supreme: Categorized 10 Concepts onto specific Grimoire Shelves!", reward: { type: "insight", amount: 10 }, track: { action: "moveConceptShelf", count: 10 } } // Added Shelf Milestone
];
...
const cardTypeThemes = { // Adding a bit more flavor
    "Orientation": "Defining the fundamental 'who' or 'what' naturally sparks your desire is a central thread in this tapestry.",
    "Identity/Role": "Exploring 'who you become' or 'how you embody energy' within intimacy or specific power dynamics seems key to your self-discovery.",
    "Practice/Kink": "The 'how' and 'what' of sexual expression – the specific actions, techniques, tools, and sensations – are prominent colors in your palette.",
    "Psychological/Goal": "Understanding the deeper 'why' – the underlying emotional needs, core motivations, and desired states – appears to be a driving force in your exploration.",
    "Relationship Style": "The 'structure' and context of connection – how relationships are formed, defined, and navigated – is a major architectural element in your intimate world."
};

// --- Onboarding Tasks --- (Enhanced descriptions/hints)
 const onboardingTasks = [
    { id: 'task01', phaseRequired: 1, description: "Peek Into Your Grimoire", reward: { type: 'insight', amount: 1 }, track: { action: 'showScreen', value: 'grimoireScreen' }, hint: "Time to open your magical book! Check out the 'Grimoire' tab up top. It's where all your discovered Concepts will live." },
    { id: 'task02', phaseRequired: 1, description: "Choose Your First Focus", reward: { type: 'insight', amount: 2 }, track: { action: 'markFocus', count: 1 }, hint: "Ready to weave? Click a Concept card (in Grimoire or after Research), hit 'Mark as Focus'. Or just tap the ☆ star on a card in the Grimoire list!" },
    { id: 'task03', phaseRequired: 2, description: "Begin Your Research", reward: { type: 'insight', amount: 2 }, track: { action: 'conductResearch', count: 1 }, hint: "Let's uncover secrets! Head to the 'Study' tab and click an Element button (like Attraction [A]) to see what knowledge you unearth (uses Insight or your Daily Free Research ☆)." },
    { id: 'task04', phaseRequired: 2, description: "Catalogue Your Findings", reward: { type: 'insight', amount: 1 }, track: { action: 'addToGrimoireFromResearch', count: 1 }, hint: "Found something cool during Research? Hit 'Add to Grimoire' on its card in the 'Research Discoveries' area below the Elements to keep it." },
    { id: 'task05', phaseRequired: 3, description: "Ponder a Reflection", reward: { type: 'insight', amount: 3 }, track: { action: 'completeReflection', count: 1 }, hint: "Time for introspection! Reflections sometimes pop up automatically after certain actions. Or, visit the Study tab and 'Seek Guidance' for a prompt!" },
    { id: 'task06', phaseRequired: 4, description: "Explore the Repository Vault", reward: { type: 'insight', amount: 1 }, track: { action: 'showScreen', value: 'repositoryScreen' }, hint: "Check the 'Repository' tab! It's a special vault holding unique unlocked items like Scene Blueprints, Experiments, and potent Insights you gather." }
];

// --- Elemental Dilemmas (Enhanced Situations/Questions) ---
 const elementalDilemmas = [
    // --- Attraction Focused ---
    {
        id: "ED_A01", elementFocus: ["A", "P"],
        situation: "An intense, almost purely physical or fetish-driven attraction [A] sparks towards someone. However, initial interactions suggest a significant lack of compatible values or potential for the deeper psychological connection [P] you typically need to feel truly fulfilled.",
        question: "Where does your energy naturally flow in deciding whether to pursue this connection further?",
        sliderMinLabel: "Prioritize Potential for Psychological Depth/Compatibility (Psychological Focus)",
        sliderMaxLabel: "Follow the Intense, Compelling Attraction Trigger (Attraction Focus)",
        elementKeyMin: "P",
        elementKeyMax: "A"
    },
    {
        id: "ED_A02", elementFocus: ["A", "R"],
        situation: "A new person enters your social sphere who strongly matches your specific 'type' or core attraction patterns [A]. Engaging with them, even platonically at first, feels like it could potentially create friction, jealousy, or violate agreements within your existing committed relationship structure [R].",
        question: "Your primary internal leaning is towards:",
        sliderMinLabel: "Prioritizing & Upholding Existing Relationship Stability/Agreements (Relational Focus)",
        sliderMaxLabel: "Exploring or Acknowledging the Potent New Attraction (Attraction Focus)",
        elementKeyMin: "R",
        elementKeyMax: "A"
    },
    {
        id: "ED_A03", elementFocus: ["A", "C"],
        situation: "You connect with someone whose mind is incredibly stimulating – their wit, intelligence, or creativity sets off major Sapiosexual sparks [A/C]. However, their physical appearance or self-presentation doesn't align with your usual visual attraction patterns or aesthetic preferences [A].",
        question: "How likely are you to initiate or pursue potential intimacy based on this?",
        sliderMinLabel: "Less Likely; Visual Cues/Aesthetics Remain Primary Gatekeepers (Attraction Focus)",
        sliderMaxLabel: "More Likely; The Powerful Mental/Cognitive Spark Overrides Visual Preferences (Cognitive/Attraction Blend)",
        elementKeyMin: "A", // Leaning towards typical A focus
        elementKeyMax: "C"  // Leaning towards the Cognitive override
    },
    {
        id: "ED04", elementFocus: ["P", "R"], // Kept ID ED04
        situation: "A long-term, trusted partner reveals a secret, deeply held desire or kink that clashes significantly with your own boundaries, comfort levels, or psychological [P] makeup, potentially straining the relationship [R] fabric.",
        question: "Your primary internal guide in responding compassionately yet authentically is:",
        sliderMinLabel: "Your Partner's Expressed Need & Relationship Harmony (Relational Focus)",
        sliderMaxLabel: "Your Own Core Boundaries & Emotional/Psychological Safety (Psychological Focus)",
        elementKeyMin: "R",
        elementKeyMax: "P"
    },
    // --- Interaction Focused ---
    {
        ...
        situation: "During an established D/s scene where you are Dominant [I], your submissive partner requests a specific, intense sensation [S] (e.g., heavier impact, a type of pain play) that you are unfamiliar with or slightly uncomfortable delivering, though it technically fits the dynamic.",
        question: "Your immediate inclination in that moment is to:",
        sliderMinLabel: "Prioritize Your Comfort/Familiarity with Delivering the Sensation (Sensory/Self Focus)",
        sliderMaxLabel: "Fulfill the Role/Dynamic Expectation & Partner's Request (Interaction Focus)",
        elementKeyMin: "S", // Can be seen as S focus (discomfort with sensation) or P (discomfort with role action)
        elementKeyMax: "I"
    },
    {
        id: "ED_I02", elementFocus: ["I", "P"],
        situation: "You naturally gravitate towards a highly structured, commanding, or protocol-heavy interaction style [High I]. However, you sense your current partner deeply needs more overt nurturing, reassurance, and psychological validation [High P need] in this moment to feel safe and connected.",
        question: "How do you adapt your interaction style right now?",
        sliderMinLabel: "Intentionally Shift Towards Nurturing & Providing Reassurance (Psychological Focus)",
        sliderMaxLabel: "Maintain Your Preferred Interaction Structure/Role Integrity (Interaction Focus)",
        elementKeyMin: "P",
        elementKeyMax: "I"
    },
    {
        id: "ED_I03", elementFocus: ["I", "C"],
        situation: "You thrive on spontaneous, intuitive interaction, letting the energy flow organically between partners [Mid I]. Your partner, however, expresses a strong desire to meticulously plan out a complex, multi-stage role-play scenario with detailed rules and character backstories beforehand [High C].",
        question: "Your preference for the upcoming encounter leans towards:",
        sliderMinLabel: "Embracing the Detailed Cognitive Planning & Structure (Cognitive Focus)",
        sliderMaxLabel: "Favoring Spontaneous Energetic Flow & Improvisation (Interaction Focus)",
        elementKeyMin: "C",
        elementKeyMax: "I"
    },
    ...
    // --- Sensory Focused ---
    {
        ...
        situation: "You have a strong craving for intense physical sensation [High S], perhaps for stress relief [P] or catharsis. However, your partner is feeling emotionally vulnerable and primarily expresses a need for gentle, comforting touch [Low S] and psychological safety [High P].",
        question: "For this specific encounter, you choose to prioritize:",
        sliderMinLabel: "Providing Gentle Comfort & Prioritizing Partner's Psychological Safety (Psychological Focus)",
        sliderMaxLabel: "Finding a way (perhaps solo later?) to Seek Your Desired Intense Sensation (Sensory Focus)",
        elementKeyMin: "P",
        elementKeyMax: "S"
    },
    {
        id: "ED_S02", elementFocus: ["S", "R"],
        situation: "An exciting opportunity arises for a high-sensation group play scenario (e.g., a BDSM play party) that promises novel sensory experiences [High S]. However, participating might push the boundaries of agreements or cause discomfort within your primary relationship(s) [R].",
        question: "Your decision-making process is most heavily weighted towards:",
        sliderMinLabel: "Protecting Existing Relationship Harmony & Honoring Agreements (Relational Focus)",
        sliderMaxLabel: "Pursuing the Novel and Exciting Sensory Experience Opportunity (Sensory Focus)",
        elementKeyMin: "R",
        elementKeyMax: "S"
    },
    {
        id: "ED_S03", elementFocus: ["S", "I"],
        situation: "You genuinely enjoy receiving specific types of impact play or intense sensation [High S]. Your partner, however, while willing, seems hesitant or unable to deliver it with the force, confidence, or intensity you desire, perhaps feeling it conflicts with their naturally nurturing or less dominant interaction style [Lower I/Dom].",
        question: "In navigating this mismatch, the focus should primarily be on:",
        sliderMinLabel: "Respecting Partner's Interaction Comfort Zone & Capabilities (Interaction Focus)",
        sliderMaxLabel: "Clearly Communicating & Guiding Towards Your Desired Sensation Level (Sensory Focus)",
        elementKeyMin: "I",
        elementKeyMax: "S"
    },
    ...
    // --- Psychological Focused ---
    {
        ...
        situation: "You harbor a deep psychological need for experiences involving surrender, vulnerability, or even helplessness [High P-Sub]. Your current partner, however, consistently prefers a very egalitarian, collaborative, non-hierarchical interaction style [Mid I], avoiding explicit power dynamics.",
        question: "When considering future interactions, you are more likely to:",
        sliderMinLabel: "Adapt Your Expectations to Match the Egalitarian Interaction Style (Interaction Focus)",
        sliderMaxLabel: "Find Ways (within this relationship or elsewhere) to Express/Fulfill Your Need for Surrender (Psychological Focus)",
        elementKeyMin: "I",
        elementKeyMax: "P"
    },
    {
        id: "ED_P02", elementFocus: ["P", "C"],
        situation: "Engaging in a specific, detailed fantasy scenario [C] is crucial for your psychological fulfillment—perhaps it makes you feel truly desired, powerful, or allows exploration of a core theme [P]. Your partner, however, finds deep fantasy immersion difficult, distracting, or prefers staying present.",
        question: "When seeking satisfaction, the priority becomes:",
        sliderMinLabel: "Focusing on Shared Reality & Finding Connection in Present Cognitive/Emotional Exchange (Cognitive/Presence Focus)",
        sliderMaxLabel: "Ensuring Your Core Psychological Need is Met, Likely Through the Fantasy (Psychological Focus)",
        elementKeyMin: "C",
        elementKeyMax: "P"
    },
    {
        id: "ED_P03", elementFocus: ["P", "A"],
        situation: "You strongly need deep emotional validation, reassurance, and feeling cherished [High P] from intimate connections. However, you find yourself overwhelmingly, magnetically attracted [High A] to someone who seems emotionally unavailable, inconsistent, or purely focused on the physical aspects.",
        question: "Your inclination in managing this internal conflict leans towards:",
        sliderMinLabel: "Pursuing the Intense Attraction, Hoping Needs Might Be Met or Setting Them Aside Temporarily (Attraction Focus)",
        sliderMaxLabel: "Prioritizing Partners/Situations More Likely to Meet Your Core Validation Need, Even if Less Intense Attraction (Psychological Focus)",
        elementKeyMin: "A",
        elementKeyMax: "P"
    },
    ...
    // --- Cognitive Focused ---
    {
        ...
        situation: "Your intricately planned fantasy or role-play scenario [High C] requires specific physical actions, props, or positioning that might be slightly uncomfortable, awkward, or disrupt a smooth, flowing sensory [S] experience for one or both partners.",
        question: "In executing the scene, you find yourself prioritizing:",
        sliderMinLabel: "Maintaining Comfortable Sensory Flow, Physical Presence & Adaptability (Sensory Focus)",
        sliderMaxLabel: "Executing the Cognitive Fantasy Accurately for Maximum Mental Immersion (Cognitive Focus)",
        elementKeyMin: "S",
        elementKeyMax: "C"
    },
    {
        id: "ED_C02", elementFocus: ["C", "R"],
        situation: "You thrive on complex rules, negotiated protocols, and clearly defined scenarios within your relationships [High C]. Your partner(s), however, prefer a much more fluid, undefined, 'go with the flow' relational approach, perhaps leaning towards Relationship Anarchy [High R].",
        question: "In navigating shared interactions and expectations, you naturally emphasize:",
        sliderMinLabel: "Flexibility, Spontaneity & Adapting to the Organic Relational Flow (Relational Focus)",
        sliderMaxLabel: "Establishing Clear Structures, Shared Understanding & Defined Agreements (Cognitive Focus)",
        elementKeyMin: "R",
        elementKeyMax: "C"
    },
    {
        id: "ED_C03", elementFocus: ["C", "P"],
        situation: "You genuinely enjoy detached, analytical mind games, witty psychological sparring, or perhaps even light, consensual manipulation play as part of intimacy [High C]. However, you sense this approach might be causing genuine emotional distress, triggering insecurity, or feeling unsafe for your partner [Low P comfort/High P need for safety].",
        question: "Your approach, valuing both stimulation and connection, tends towards:",
        sliderMinLabel: "Immediately Prioritizing Partner's Emotional Safety, Comfort & Trust (Psychological Focus)",
        sliderMaxLabel: "Continuing to Engage in the Stimulating Cognitive Game, Perhaps Adjusting Intensity (Cognitive Focus)",
        elementKeyMin: "P",
        elementKeyMax: "C"
    },
    ...
    // --- Relational Focused ---
    {
        ...
        situation: "You are content and committed within a happily monogamous relationship structure [Low R score area]. Unexpectedly, you develop a strong, persistent, and potentially disruptive romantic or sexual attraction [A] towards a close friend or colleague.",
        question: "Your primary internal conflict and focus centers on:",
        sliderMinLabel: "Understanding & Navigating the Nature of These New Feelings/Attraction Patterns (Attraction Focus)",
        sliderMaxLabel: "Honoring Your Existing Commitment & Maintaining the Integrity of Your Relationship Structure (Relational Focus)",
        elementKeyMin: "A",
        elementKeyMax: "R"
    },
    {
        id: "ED_R02", elementFocus: ["R", "I"],
        situation: "You actively practice Relationship Anarchy [High R], deeply valuing autonomy and rejecting pre-defined roles or hierarchies. However, a partner expresses a strong desire for a more defined, perhaps traditional, D/s dynamic involving specific protocols and titles [High I].",
        question: "Your response prioritizes finding a path that emphasizes:",
        sliderMinLabel: "Exploring and Accommodating the Desired Interaction Dynamic Within Your Connection (Interaction Focus)",
        sliderMaxLabel: "Maintaining Your Core Principles of Relational Autonomy & Resisting Imposed Structures (Relational Focus)",
        elementKeyMin: "I",
        elementKeyMax: "R"
    },
    {
        id: "ED_R03", elementFocus: ["R", "S"],
        situation: "Your polyamorous constellation [High R] includes partners with vastly different, perhaps even conflicting, sensory preferences (e.g., one loves intense impact [S], another finds it triggering). This makes planning inclusive group encounters challenging.",
        question: "When trying to organize group connection time, your logistical focus leans more towards:",
        sliderMinLabel: "Structuring Activities to Maximize Potential Sensory Fulfillment for Individuals (Sensory Focus)",
        sliderMaxLabel: "Prioritizing Activities that Foster Group Cohesion & Shared Relational Dynamics (Relational Focus)",
        elementKeyMin: "S",
        elementKeyMax: "R"
    }
];
...
// --- FINAL EXPORT BLOCK --- (Ensure all variables are included)
export {
    // Core Data
    elementDetails,
    concepts, // Essential! Contains all concept data.
    ...
    // Unlock Mechanisms
    focusDrivenUnlocks,
    categoryDrivenUnlocks, // Make sure this is exported
    // UI/Config Helpers
    onboardingTasks, // Export if used
    elementInteractionThemes,
    cardTypeThemes,
    grimoireShelves, // Make sure this is exported
    elementalDilemmas // Make sure this is exported
};

console.log("data.js FULLY loaded... Grimoire unlocked, lore deepened, dilemmas poised, ready for alchemical exploration!");
console.log("data.js processing complete.");
// --- END OF FILE data.js ---
