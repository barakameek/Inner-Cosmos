...
export const STATUS_EFFECTS = {
    ...
    'Regen': {
        ...
        name: 'Regeneration',
        type: 'buff',
        description: 'At the end of your turn, heal Integrity equal to the amount. Duration decreases each turn.', // Clarified description
    ...
    'Intangible': {
     ...
     'ProtocolActive': { // NEW: For RoleFocus Limelight
         id: 'ProtocolActive',
         name: 'Protocol Active',
         type: 'buff',
         description: 'Enhances specific actions while active (e.g., Interaction cards gain bonus effects). Amount may increase effect. Duration decreases each turn.',
         icon: 'fa-solid fa-scroll', // Or maybe fa-cog, fa-cogs, fa-network-wired? Scroll works.
         stacking: true, // Amount might increase effect or represent charges
         durationBased: true, // Typically has a duration that ticks down
         persists: false // Combat only effect
     },
     ...
     'TemporaryHP': { // For Stubborn Psyche artifact (Needs Player logic)
         id: 'TemporaryHP',
         name: 'Temporary HP',
         type: 'buff',
         description: 'Increases maximum Integrity temporarily (effect removed end of combat).',
     ...
     // Example: Retain Status (Needs logic in DeckManager/Player)
      'Retain': {
           id: 'Retain',
           name: 'Retain',
           type: 'buff', // Often applied to cards, not player, but could be a player buff affecting hand
           description: 'Cards in hand are not discarded at the end of turn.',
    ...
    'Poison': {
        ...
        stacking: true, // Amount stacks
        durationBased: false, // Effect tied to amount, not turns directly (removed when amount hits 0)
        persists: false
    },
    'Burn': {
         id: 'Burn',
         name: 'Burn',
         type: 'debuff',
         description: 'At the start of turn, takes damage equal to the amount. Duration decreases each turn.', // Clarified description
